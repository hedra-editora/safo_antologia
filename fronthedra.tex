...
{{\footnotesize{} \ifdef{\numeroedicao}{\numeroedicao}{2}ª edição revista e ampliada} \par}
%logos
\vfill
\normalsize
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{\logo}\hfill\logoum{}\\ São Paulo\_\the\year}}{\logoum\break{} São Paulo\quad2021}
...
\centering\tiny\noindent{}Adverte-se aos curiosos que se imprimiu este livro na gráfica Meta Brasil, 
em \today \ifdef{\papelmiolo}{em papel \papelmiolo}, em tipologia Formular, Porson e Minion Pro, com diversos sofwares livres, 
