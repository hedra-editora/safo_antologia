...
ἔλθε μοι καὶ νῦν, χαλέπαν δὲ λῦσον\\ \EP[2]
...
{Esse \textit{hino clético} --- prece que invoca a deidade para instá"-la a vir à
...
(versos 2-8: ilegíveis e lacunares)
...
\begin{verse}
\Porson
(versos 1-4 e verso 11: ilegíveis e lacunares)
...
\begin{verse}
\Porson
a\quad Ἔσπερ’ ὐμήναον

b\quad ὦ τὸν Ἀδώνιον
\end{verse}
...
{\paragraph{Comentário} Segundo a fonte, Pólux (\textit{Onomástico} 10.124, século \textsc{ii} d.C.), Safo descreve Eros
quando canta:}
...
b (versos 1-4 e verso 10: ilegíveis e lacunares)
...
\section{A saga troiana: as bodas de Heitor e Andrômaca (Fr.~44)\footnoteInSection{ Ver
...
\textit{priamel} --- como\linebreak

\noindent{}se designa a estrofe inicial, em que a uma série de
...
ὠσπ.[\ldots{}].ώομεν, .[\ldots{}]..χ[\ldots{}]\\
    σε †θεασικελαν ἀρι-\\
      γνωτα†, σᾶι δὲ μάλιστ’ ἔχαιρε μόλπαι·̣
...
(versos 24-5: ilegíveis e lacunares)
...
(versos 30-2: ilegíveis e lacunares)

[\qquad			]ες τὸ Γεραίστιον\\
    [\qquad			   ]ν ̣φίλαι

(versos 35-6: ilegíveis e lacunares)
\end{verse}
...
\begin{verse}
\Porson
b (versos 1-4 e 28: ilegíveis e lacunares)
...
(versos 28-9: ilegíveis e lacunares)
\end{verse}
...
\begin{verse}
\Porson
a\quad	ἔμεθεν δ’ ἔχηισθα λάθαν

b\quad	ἤ τιν’ ἄλλον ἀνθρώπων ἔμεθεν φίληισθα
...
\begin{verse}
\Porson
μνάσεσθαί τινα φα<ῖ>μι †καὶ ἔτερον† ἀμμέων
\end{verse}
...
\begin{verse}
\Porson
(versos 1-3 e 14-6: ilegíveis e lacunares)
...
\Porson
ἔγω δ’ ἐπὶ μολθάκαν\\
τύλαν <κας>πολέω †μέλεα· κἂν μὲν τετύλαγκας ἀσπόλεα†
\end{verse}
...
pois eu não seria assim \ldots{}\\ \EP[2]
berloques \ldots{}
...
{\paragraph{Comentário} Citado pelo gramático Apolônio Díscolo na discussão sobre pronomes, mesma fonte do Fr. 32, o 149 traz apenas um verso, que diz:}
...
\begin{verse}
\Porson
(versos 1 e 22-5: ilegíveis e lacunares)
...
(versos 14-9: ilegíveis e lacunares)
...
{\paragraph{Comentário} Segundo a fonte do fragmento, um escólio a Sófocles (século \textsc{v} a.C.) e à
...
{\paragraph{Comentário} A fonte do fragmento é, como no caso do 101\versal{A}, Demétrio, que trata do charme na
expressão:}
...
{\paragraph{Comentário} Apolônio Díscolo (\textit{Sobre os pronomes} 124c), fonte dos Frs.~32 e 33, cita os versos abaixo:}
...
ὔ]μως δ’ ἔγεν[το\\
      ...
      b (versos 1-2 e 4-6: ilegíveis e lacunares)
...
{\paragraph{Comentário} Aristóteles (século \textsc{iv} a.C.), na \textit{Retórica} (1367a), afirma: 
...
\begin{verse}
\Porson
a\quad Ἔσπερε πάντα φέρηις ὄσα φαίνολις ἐσκέδασ’ Αὔως,\\
      φέρηις ὄιν, φέρηις αἶγα, φέρηις ἄπυ μάτερι παῖδα.

b\quad ἀστέρων πάντων ὀ κάλλιστος
\end{verse}
...
\begin{verse}
\Porson
a\quad οἶον τὸ γλυκύμαλον ἐρεύθεται ἄκρωι ἐπ’ ὔσδωι,\\
ἄκρον ἐπ’ ἀκροτάτωι, λελάθοντο δὲ μαλοδρόπηες·\\
οὐ μὰν ἐκλελάθοντ’, ἀλλ’ οὐκ ἐδύναντ’ ἐπίκεσθαι

b\quad οἴαν τὰν ὐάκινθον ἐν ὤρεσι ποίμενες ἄνδρες\\
...
não, não o esquecem --- mas não o podem alcançar \ldots{} \EP[1]
...
\textls[-21]{\paragraph{Comentário} Citados por Siriano, comentador bizantino do tratado de estilística de
...
\begin{verse}
\Porson
(versos 1-3: ilegíveis e lacunares)
...
\begin{verse}
\Porson
(versos 1-2 e 14-6: ilegíveis e lacunares) 
...
\pagebreak
{\paragraph{Comentário} Tendo por fonte o Papiro de Berlim 9722, que nos trouxe o Fr. 96, entre outros, o 92 traz apenas algumas palavras em inícios de versos, mas todas ligadas a vestes e adornos que são objeto de cuidado nos grupos corais femininos e tema de suas canções, como mostram Álcman e seus partênios, e as muitas canções de Safo que já vimos. Note"-se ainda o colorido acentuado em certos termos --- colorido que se faz presente no praticamente ilegível Fr. 100, cuja única linha não se discerne e não está aqui traduzida.}
...
\begin{verse}
\Porson
(versos 1 e 13-5: ilegíveis e lacunares)

ὄ]ττινα[ς γὰρ\\
εὖ θέω, κῆνοί με μά]λ̣ιστα πά[ντων\\
σίνονται̣

(versos 5-6: ilegíveis e lacunares)
...
\pagebreak
{\paragraph{Comentário} A fonte do fragmento é o \textit{Papiro de Oxirrinco} 1231, como também do Fr.
...
{\paragraph{Comentário} Na \textit{Exortação à aprendizagem} (8.16), Galeno (século \textsc{ii} d.C.) cita dois versos
...
\textls[-20]{\paragraph{Comentário} Preservado no \emph{Papiro de Oxirrinco 1231}, em que estão vários
...
velhice seja obstáculo ao cantar que honra a figura de ``colo violáceo'' \EP[1]
...
\begin{verse}
\Porson
(versos 1-4: ilegíveis e lacunares)
