...
Noto, quanto ao verso inicial, que traz os mesmos termos (\textit{eúpoda nýmphan}), na mesma sequência e declinação em que se acham no Fr.\,103\textsc{b}, no qual só se lê ainda uma palavra, ``quarto nupcial'', \textit{thalámō}.
...
\paragraph{Comentário} \textls[-10]{Nesse parco fragmento preservado, como o Fr.\,126, no \textit{Etimológico genuíno}, combina"-se um binômio recorrente na poesia erótica grega:
...
\paragraph{\textsc{nota introdutória}}
\textls[-5]{Como observei ao comentar o Fr.\,96 de Safo, é notável em sua mélica o trabalho
...
\textit{Ilíada},}\looseness=-1\footnote{\textsc{viii}, 555.} \textls[-10]{em passo sobre o brilho dos astros no enredor da destacada lua.}\looseness=-1
