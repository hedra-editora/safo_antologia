...
\pagebreak
\paragraph{Comentário} Esse \textit{hino clético} --- prece que invoca a deidade para instá"-la a vir à 
...
\paragraph{Comentário} \textls[-13]{Preservado na mesma fonte do Fr.\,65, o 73\,\textsc{a} mostra a \textit{persona} a se dirigir a Afrodite no primeiro verso minimamente legível,}\looseness=-1\footnote{Verso 3.} \textls[-13]{mas nada podemos saber da cena desenhada. O adjetivo \textit{adýlogoi}, ``de doce fala'', no verso 4, talvez qualifique o termo \textit{éros} na forma plural, \textit{érōtes}, que, todavia, não se atesta em Safo.}\looseness=-1
