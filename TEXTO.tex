...
e 140. Neles, o tema da presença da deusa \emph{corpus} foi estudado em Ragusa (2005), em que se baseiam as traduções dos e as notas aos fragmentos legíveis desse \emph{corpus}. Tais traduções, como outras publicadas previamente a esta nova edição da antologia, podem estar aqui ligeiramente alteradas.} O fato
...
\paragraph{Comentário} \textls[-20]{A única fonte do Fr.\,15 é o \emph{Papiro de Oxirrinco} 1231 (século \textsc{ii} d.\,C.). 
...
os limites de sua condição e, por isso, ser punido.}\looseness=-1
...
\textls[-20]{Tal resposta, imperativa, demanda das \emph{kórai}, ``meninas'' ou ``virgens'', a gestualidade fúnebre tradicional do lamento feminino, chamada \emph{góos}), atestada na iconografia e na \emph{Ilíada} \textsc{xviii},}\looseness=-1\footnote{30--1, 50--1.} \textls[-20]{no pranto das servas e das Nereidas pela morte de Pátroclo.
...
Heféstion (10.4), a mesma do Fr.\,102. E como Herington}\looseness=-1\footnote{1985, p.\,57.} \textls[-20]{afirma, a estrutura dramática do Fr.\,140,  como a do 114, ``antecipa'' cenas semelhantemente trabalhadas na tragédia ática: ``Somos colocados num evento mítico [\ldots{}] que não está sendo narrado, mas imediatamente apresentado''; logo,  temos que creditar a Safo, e a mais ninguém, o mais antigo fragmento de drama em verso, preservado em toda a tradição europeia [\ldots{}]''. Canto dialogado coral fúnebre, o fragmento anuncia a própria \emph{performance} pública --- possivelmente ``uma \emph{reperformance} da morte em vida de Adônis por um grupo de suas adoradoras''.}\looseness=-1\footnote{Herington.} \textls[-20]{Diga"-se, por fim: ``Um dos gêneros de discurso público associados à mulher tanto na Grécia arcaica, quanto na rural de hoje, é o lamento'',}\looseness=-1\footnote{Lardinois 1996, p.\,172.} \textls[-20]{justamente o gênero do Fr.\,140. Em conformidade com a lógica
paidêutica do grupo coral liderada por Safo, a dramatização da dor lutuosa de Afrodite que ensina as moças a prantear a morte de Adônis permiti"-lhes vivenciar no mito a experiência fúnebre, parte da vida cotidiana. Talvez a presença das meninas, em vez das mulheres --- como nos cultos das Adonias ---, se deva à dimensão da \emph{paideía} das jovens do coro que, desse modo, ``lamenta com ou como Afrodite a perda de Adônis''.}\looseness=-1\footnote{Stehle 1997, p.\,224.}
...
erótico, como indica a linguagem dos dois primeiros versos. E se Andrômeda é mesmo poeta rival de Safo, esta pode estar a censurar Átis,\footnote{\textls[-20]{Além dos fragmentos que veremos aqui, o nome é a única palavra legível no Fr.\,8.}\looseness=-1} nome de uma das virgens do coro outras vezes presente nas canções, por ter saído de seu grupo para passar ao daquela líder. O fragmento está preservado no tratado do metricista Heféstion (7.7), já
referido no Fr.\,102.
...
sobre o desenho das deusas. E são as Cárites, segundo a \emph{Teogonia},\footnote{Versos 64--67.} de Hesíodo, vizinhas das Musas e de Hímeros (Desejo) no Olimpo --- imagem refletida na presença daquelas deusas e do erotismo no Fr.\,128. Deste --- cuja fonte é Heféstion (9.2), como no caso do Fr.\,102 --- e do
...
\begin{verse}
\textls[-20]{\ldots{} elas [as Musas] me fizeram honrada, suas próprias}\looseness=-1\\
...
\textls[-20]{e a nova, cruzando a ampla cidade, chegou aos amigos.}\looseness=-1\\
...
{\paragraph{Comentário} \textls[-20]{Preservado no mesmo rolo papiráceo do Fr.\,96, o 94 é fortemente dramático ao
...
{\paragraph{Comentário} Preservado em fontes do século \textsc{iii} a.\,C., o \emph{Papiro de Copenhagen} 301 (\textbf{a}) e o \emph{Papiro de Milão} 32 (\textbf{b}),
...
principal o \emph{Hino homérico \textsc{v}, a Afrodite},\footnote{Versos 218--238.} \textls[-20]{datado do
