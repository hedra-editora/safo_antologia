...
\begin{verse}
\ldots{} vindo do céu, envolto em purpúreo manto \ldots{} %\rlap{}
\end{verse}
...
\textit{Ilíada }(\textsc{viii}, 555), em passo sobre o brilho dos astros no enredor da destacada lua.} %enredor?
...
{\paragraph{Comentário} Ateneu (2.54f), fonte do Fr.~141 já aqui visto, atribui a Safo a descrição abaixo:}
...
{\paragraph{Comentário} É fonte do fragmento o \textit{Etimológico magno} (2.43); nele, o “eu”
