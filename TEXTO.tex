...
%\footnote{Mantenho para o Fr. 5, como para outros (15, 16, 17), os textos da edição Voigt (1971). Preferi não adotar os textos modificados apresentados com base em novos papiros que estiveram, e assim permanecem, envoltos em complexas questões, se não de estabelecimento de autoria, de procedência, de verificação e de ordem ética. Recomenda"-me a prudência, mesmo se excessiva no entender dos que me leem, aguardar a solução dos problemas e estabilização das disputas. A quem deseja, poderá acessar na Editora Brill, acompanhado de nota de retratação dos editores, o volume organizado por Anton Bierl e André Lardinois, \textit{The newest Sappho}. P. Sapph. Obbink and P. GC inv. 105, frs. 1--4. \textit{Studies in archaic and classical song}, vol. 2 (2016).}
...
\vinphantom{ὄ̣ρ̣ματ̣α̣ι̣}    ἴ]κελοι θέοι[ς\\
\vinphantom{ὄ̣ρ̣ματ̣α̣ι̣}     ] ἄγνον ἀολ[λε\\
...
\paragraph{Comentário} Citado em anônimo comentário reunido junto a outros dispersos na coletânea \textit{Anedota Oxfordiana} (i 190, século \textsc{xix}), o fragmento surge a propósito de um verso da \textit{Ilíada} (\textsc{i}, 528), que com o termo equivalente (\textit{ē̂}) ao usado por Safo (\textsc{ē̂si}), observa o comentador, expressa o dizer em 3ª pessoa do singular. Nele, há apenas três palavras, ligadas decerto à passagem da noiva de sua própria família à do noivo, pelas mãos do pai.
...
{\paragraph{Comentário} Preservado no \textit{Papiro de Oxirrinco 1787}, fonte do Fr. 65 e de outros, o 62, cujo início e final são marcados, conjuga doçura, viagem, louro, ouvir, vestes, chegar-vir, beleza, de modo que nos escapa, mas que coloca em cena muito possivelmente figuras femininas. Seria o coro o referente de ``vós'', e a líder a \textit{persona} em 1ª pessoa do singular? Seria mais uma canção enfocando vestes e enlaçando"-as a alguma recordação de uma jovem já ida?} %%PROBLEMA DE TAMANHO
...
15. O que se lê parece centrar"-se numa discussão de caráter ético"-moral
