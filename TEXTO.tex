...
virgindade, desejada pela deusa, concedeu"-a Zeus à filha, conta o \textit{Hino homérico a Afrodite} (século \textsc{iv} a.C.), autoria incerta.}
...
E na segunda, o casamento faz"-se, como de fato é, uma espécie de morte,\footnote{Swift, 2010, p. 250.} porque provoca a transição irreversível de uma vida, a de \textit{parthénos}, ``moça'', para a outra, a de \textit{gynéé}, ``mulher''. Como observei no comentário ao Fr.\,44, cujo tema é a boda mítica de Heitor e Andrômaca, são muitos e especificamente gregos os paralelos entre as cerimônias nupcial e fúnebre.\footnote{Redfield 1982, p. 188.}
...
\paragraph{Comentário} Citado em anônimo comentário reunido junto a outros dispersos na coletânea \textit{Anedota Oxfordiana},\footnote{\textsc{i} 190, século \textsc{xix}.} o fragmento surge a propósito de um verso da \textit{Ilíada},\footnote{\textsc{i}, 528.} que com o termo equivalente (\textit{ê}) ao usado por Safo, \textsc{êsi}, observa o comentador, expressa o dizer em 3ª pessoa do singular. Nele, há apenas três palavras, ligadas decerto à passagem da noiva de sua própria família à do noivo, pelas mãos do pai.
