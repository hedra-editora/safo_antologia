...
\vspace*{\fill}
\begin{verse}
\small{Ó Safo, aos jovens que amam o mais doce travesseiro das\qb{}paixões,\\
...
ou junto a Afrodite enlutada, lamentando o jovem\qb{}rebento de\\
Ciniras, contemplas o bosque sacro dos venturosos.\\
Em toda parte, ó soberana, te saúdo como aos deuses,\qb{}pois tuas\\
canções ainda hoje consideramos filhas dos imortais.}
\end{verse}

\begin{flushright}
\small{\textsc{dioscúrides, séc.\,iii a.c.}}\\
\small{\emph{Antologia palatina}, \textsc{vii}, ep.\,407}
\end{flushright}
...
\setbeforesecskip{1.2\onelineskip}%
  ...
  \setsecheadstyle{\large\baselineskip=.7\baselineskip\scshape\MakeTextLowercase}%

\begin{argumento}
Nenhuma outra divindade grega aparece nas canções de Safo com a mesma
frequência, nem do mesmo modo: Afrodite é a mais presente. O fato
...
poética dos versos. Considerada a mélica grega arcaica, a diferença da Afrodite sáfica para a representação da deusa nos demais poetas é evidente, como busquei demonstrar (Ragusa, 2010).
A seguir, as canções que trazem a deusa, cujas traduções e anotações retomam o estudo que lhes dediquei (Ragusa, 2025), com atualizações e pequenas modificações.
...
\paragraph{Comentário} Esse \emph{hino clético} --- prece que invoca a deidade para instá"-la a vir à 
...
\emph{éros} como patologia de corpo e mente,\footnote{Versos 3--4.} que, em princípio,
...
a mais famosa canção de Safo, mas a única integralmente preservada em citação, feita no tratado \emph{Sobre o arranjo das palavras},\footnote{Número 23.} de Dionísio de Halicarnasso (retórico, século \textsc{i} a.\,C.). Mais: é a primeira canção do livro \textsc{i} de Safo,
compilado na célebre Biblioteca de Alexandria, provavelmente na virada dos
séculos \textsc{iii}--\textsc{ii} a.\,C.
Todo plasmado como é em Afrodite, a deusa \emph{sýmmakhos} de ``Safo'' que lhe pede e antecipa sua presença, pode"-se pensar o epíteto e o hino como um todo em dimensão metapoética, à semelhança do que se passa com o Fr.\,2, adiante. Nessa dimensão, ``Safo'' dramatiza"-se como ``uma mulher líder de um grupo feminino e uma poeta totalmente dedicada à esfera da beleza, do amor, e de Afrodite'',\footnote{Bierl 2018, p.\,929.} e o faz nas derradeiras palavras, ``drasticamente revertendo seu sentimento inicial de devastação e depressão'', para se afirmar qual ``autoconfiante \emph{choregos}, ‘líder do coro’, e cantora poética''.\footnote{Bierl, p.\,930.} ``Reencenando essa divina aliada de luta na própria \emph{performance}, a canção faz Safo se fundir a Afrodite. Assim, em qualquer \emph{performance}, Safo se torna Afrodite, como a cantora perfeita, plena de encantamento poético e erótico''.\footnote{Bierl, p.\,948.}
...
{\paragraph{Comentário} Eis outro \emph{hino clético}, em que se destaca o detalhamento do local ao
...
{\paragraph{Comentário} No fragmento preservado no \emph{Papiro de Oxirrinco} 7 (século \textsc{iii} d.\,C.),
...
irmão''.\footnote{Verso 2.} Uma vez que o \emph{eu} da poesia de Safo é habitualmente
identificado à própria poeta, é leitura corrente que o \emph{ele} é Cáraxo, com base
em Heródoto (século \textsc{v} a.\,C., \emph{Histórias}, \textsc{ii}, 134--135), segundo quem uma
\emph{hetera} de nome Rodopis, feita escrava, foi levada para o Egito do faraó Amásis
(\emph{c.}\,570 a.\,C.) por um homem que, depois, a libertou em troca de vultoso
...
Safo ao \emph{eu} da canção, o qual pode ser outra personagem.
...
relativo à sua ``irmã'', que não sabemos quem é.\footnote{Mantenho para o Fr.\,5 (e outros) a edição Voigt (1971). Preferi não adotar reedições com base em novos papiros envoltos em complexas questões, das quais dá ideia a nota de retratação de Anton Bierl e André Lardinois, editores de \emph{The newest Sappho} (Brill, 2016). Recomenda"-me a prudência, mesmo se excessiva, aguardar a estabilização do cenário.}}
...
\textnormal{[\emph{versos 2--8: ilegíveis e lacunares}]}
...
\paragraph{Comentário} A única fonte do Fr.\,15 é o \emph{Papiro de Oxirrinco} 1231 (século \textsc{ii} d.\,C.). 
...
parece ser feita uma prece a Afrodite, ou ``Cípris'': o \emph{eu} pede"-lhe a
...
\textnormal{[\emph{verso 1: ilegível e lacunar}]}
...
{\paragraph{Comentário} Nessa canção fragmentária, também preservada no \emph{Papiro de Oxirrinco}
1231, dignas de notas são a referência à ``harpa'',\footnote{[\emph{Pâ}]\emph{ktin}, verso 11.} instrumento muito
antigo e de procedência oriental, e ao voo do desejo, na imagem poética
recorrente da excitação erótica, ao redor de um \emph{tu} --- voo este que se repete
no presente da canção, como antes, no passado, revela o advérbio ``de
novo'', \emph{dēûte},\footnote{Verso 11.} a marcar, como no Fr.\,1,\footnote{Versos 15, 16, 18.} a intermitência de \emph{éros}. A sensualidade da cena se intensifica com o vestido captado pelos olhos do \emph{eu}, motivo de sua alegria e gatilho de uma recordação em que se insere Afrodite, a
...
desejo--olhar. Afinal, sendo \emph{éros} o desejo sexual, é pelos olhos que entra --- os que contemplam a beleza do corpo físico. Mas o elemento do vestido e o modo como é enfocado na canção é muito característico da mélica de Safo, que amiúde realça peças do vestuário feminino. Sobre isso, um conjunto de fragmentos adiante traduzidos dirá algo mais.}
...
o tratado \emph{Sobre a sintaxe} (3.247), do gramático Apolônio Díscolo (século
\textsc{ii} d.\,C.).}
...
\textnormal{[\emph{versos 1--4 e 11: ilegíveis e lacunares}]}
...
\begin{gkverse}
\textnormal{[\emph{versos 1--2: ilegíveis e lacunares}]}
...
\paragraph{Comentário} \textls[-13]{Preservado na mesma fonte do Fr.\,65, o 73\textsc{a} mostra a \emph{persona} a se dirigir a Afrodite no primeiro verso minimamente legível,}\looseness=-1\footnote{Verso 3.} \textls[-13]{mas nada podemos saber da cena desenhada. O adjetivo \emph{adýlogoi}, ``de doce fala'', no verso 4, talvez qualifique o termo \emph{éros} na forma plural, \emph{érōtes}, que, todavia, não se atesta em Safo.}\looseness=-1
...
\paragraph{Comentário} Tendo por fonte a mesma do fragmento anterior, o 86 de novo revela a \emph{persona} a falar a Afrodite, nomeada Citereia --- como no Fr.\,140 e em boa parte da poesia grega antiga, pela sua ligação mítico"-cultual com a ilha de Citera ---, e em linguagem muito similar à do Fr.\,1, da segunda estrofe.\footnote{Versos 5--8.} É certo que é uma prece, possivelmente um hino clético à deusa, tal qual os Frs. 1 e 2, que igualmente refere Zeus, a quem o epíteto ``porta"-égide'', \emph{aigiókhō},\footnote{Verso 2.} costuma ser atribuído.
...
{\paragraph{Comentário} O \emph{eu} feminino desse fragmento, cuja fonte principal é o \emph{Inquérito
sobre os metros} (10.5), de Heféstion (século \textsc{ii} d.\,C.), dirige uma queixa à sua
``doce mãe'', \emph{glýkēa mâter}:\footnote{Verso 1.} domada pela paixão por um menino, por ação de Afrodite, acha"-se impotente, incapaz de prosseguir com o trabalho no tear. Na dupla de
...
--- a ``tecelã de ardis'', \emph{dolóploke},\footnote{Verso 2.} no Fr.\,1 ---, e do tecer de tramas, tarefa feminina, que, metaforicamente, alude à ação de enganar, própria da sedução.
...
menina doente de paixão. O \emph{eu} do fragmento é, pois, dramático, como o é
...
Da importância do epitalâmio no \emph{corpus} de Safo e, mais, no universo em que a poeta e seu coro de \emph{parthénoi} se encontram, falei na introdução e na nota a esta segunda edição deste trabalho, lembrando, entre outras evidências que se somam às próprias canções de Safo, a existência de um livro só de mélica epitalâmica na compilação de sua obra  em Alexandria, na famosa Biblioteca. Recordo ainda testemunhos antigos como o de Himério, retórico do século \textsc{iv} d.\,C., que diz na \emph{Oração 9},\footnote{33--47.} ou \emph{Epitalâmio para Severo}, seu aluno: ``[\ldots{}] os ritos de Afrodite foram deixados a Safo de Lesbos, para que os cantasse para a lira e os fizesse para o tálamo. Após os concursos, ela seguia para o tálamo, ornamentava o aposento nupcial, preparava o leito, recrutava as virgens, liderava"-as ao quarto da noiva, e também Afrodite sobre o carro das Cárites --- deusas Graças ---, e o coro de Erotes, companheiro de folguedos''.

No Fr.\,112, canta"-se a felicidade do noivo qualificado por ela, \emph{ólbios};\footnote{Verso 1.} trata"-se de um exemplo de \emph{makarismós}, a tradicional ``enunciação do casal como feliz e abençoado'',\footnote{Swift, 2010, p.\,246.} que vem da tradição popular, tal qual o elogio dos noivos, também feito nos versos.
...
\textsc{vi} d.\,C.) dizia, na obra \emph{Epitalâmios em Zacarias} (19): ``Portanto, eu
...
\begin{verse}
``Tem Andrômeda bela paga \ldots{}''\\[2mm]
...
lança uma pergunta a ``Safo'', \emph{persona }da poeta no fragmento de
...
feliz (\emph{polýolbon})?\footnote{Verso 2.} Sua fonte de transmissão é o tratado do metricista Heféstion (14.7), referido
no Fr.\,102.}
...
referido no Fr.\,102. Nele, projeta"-se a intimidade da \emph{persona} de Safo com Afrodite, pois não é a deusa que lhe fala, como tradicionalmente, mas a poeta que a ela se dirigiu no passado do sonho sonhado, que parece recontar a alguém.
...
Adônis cantou'';\footnote{\emph{Descrição da Grécia}, \textsc{ix}, 29, 8.} prova isso o Fr.\,140, 
...
Tal resposta, imperativa, demanda das \emph{kórai}, ``meninas'' ou ``virgens'', a gestualidade fúnebre tradicional do lamento feminino, chamada \emph{góos}), atestada na iconografia e na \emph{Ilíada} \textsc{xviii},\footnote{30--1, 50--1.} no pranto das servas e das Nereidas pela morte de Pátroclo.
...
\paragraph{Comentário} \textls[-10]{Preservado por Mário Plotino Sacerdo (século \textsc{iii} d.\,C.), em sua
...
talvez também pranteassem a morte do belo amado de Afrodite, lá cantado. Na canção perdida, de que temos só a sequência acima, a deusa poderia estar presente junto a ele.}\looseness=-1
...
Biblioteca de Alexandria passaram a ser chamadas pelo termo epitalâmio,\footnote{Literalmente, ``sobre o leito nupcial, o tálamo''.} as linhas não contíguas (\emph{a}, \emph{b}) viriam de uma composição talvez enlaçada ao mito de Adônis, de que falei no
...
(\emph{b}); em vista do contexto epitalâmico que traz o deus da boda, do
...
tradição mítico"-poética, iconográfica e cultual da Grécia antiga. A relevância do universo feminino certamente favorece a
...
sensos, qual vento montanha abaixo caindo sobre as\qb{}árvores\ldots{}
\end{verse}

\medskip
\paragraph{Comentário} A fonte do fragmento é uma \emph{Oração} (18), do retórico Máximo de Tiro (século \textsc{ii} d.\,C.). 
Note"-se como a imagem da tempestade ou ventania violenta é usada para falar de Eros a se abater sobre a \emph{persona}, comprometendo sua estabilidade mental, na medida em que lhe atingi os ``sensos'', \emph{phrénas}.\footnote{Verso 2.} Veremos sobretudo no Fr.\,31 a síntese do sofrimento erótico, mas já no Fr.\,1\footnote{Versos 3--4.} se faz presente.
...
\paragraph{Comentário} Segundo a fonte, Pólux,\footnote{\emph{Onomástico} 10.124, século \textsc{ii} d.\,C.} Safo descreve Eros quando canta o verso acima.
...
dulciamara inelutável criatura \ldots{}\\[2mm]
...
\emph{éros}, o deus ou a força. O segundo par traz duas figuras femininas
...
referido no Fr.\,102.
Abaixo, na caracterização de Eros, merecem destaques os adjetivos  compostos \emph{lysimelés} --- que Hesíodo já lhe dá na \emph{Teogonia} (121) ---, que marca a fragmentação do sujeito, e \emph{glýkypikron} --- primeiro doce, depois, amargo ---, o adjetivo \emph{amákhanon}, que marca a impotência em que se acha o amador diante de deus; e \emph{órpeton}, que nomeia criaturas rastejantes, arrepiantes, como as serpentes que paralisam de temor o sujeito que as vê.}
...
\paragraph{Comentário} \textls[-10]{Citado por Máximo de Tiro, fonte do Fr.\,47, o 188 traz apenas uma palavra, \emph{mythoplókon}, que teria sido dita sobre Eros por Safo, diz o antigo retórico. O adjetivo pode se referir à eloquência da sedução, potencialmente enganadora, como indicaria o tecer que no mundo erótico tem tal conotação, como vimos no Fr.\,1 e no epíteto \emph{dolóploke} para Afrodite, a ``tecelã de ardis''.}\looseness=-1\footnote{Verso 2.}
...
\textnormal{[\emph{versos 1--4 e 10: ilegíveis e lacunares}]}
...
\ldots{} grande título\\
{[}Eros{]} dela nunca se achega \ldots{}\\[2mm]
...
\paragraph{Comentário} \textls[-15]{Apenas neste fragmento, e no de resto ilegível Fr.\,84, cuja fonte é o \emph{Papiro Fouad} 239 (séculos \textsc{ii} ou
...
virgindade, desejada pela deusa, concedeu"-a Zeus à filha, conta o \emph{Hino homérico a Afrodite} (século \textsc{iv} a.\,C.), de autoria incerta.}\looseness=-1

\begin{argumento}
Quase sempre nomeadas coletivamente, as Cárites ou Graças integram o séquito de Afrodite.
Esse elo reflete afinidades sobretudo no universo erótico, uma vez que as
deusas, cujo nome é a forma do plural de \emph{kháris } --- conceito que vai de
...
sobre o desenho das deusas. E são as Cárites, segundo a \emph{Teogonia} (v.\,64--67), de Hesíodo, vizinhas das Musas e de Hímeros (Desejo) no Olimpo --- imagem refletida na presença daquelas deusas e do erotismo no Fr.\,128. Deste --- cuja fonte é Heféstion (9.2), como no caso do Fr.\,102 --- e do
Fr.\,53 --- cuja fonte é um comentário antigo ao \emph{Idílio }28, do poeta
...
\begin{verse}
Ó sacras Cárites, róseos braços, para cá, moças de\qb{}Zeus \ldots{}
\end{verse}
...
\begin{verse}
\ldots{} há pouco Eos de áurea sandália \ldots{}
\end{verse}
...
tratado \emph{Sobre palavras similares, mas diferentes} (75), do gramático Amônio
(século \textsc{ii} d.\,C.).
...
\textnormal{[\emph{versos 16--8: ilegíveis e lacunares}]}
...
{\paragraph{Comentário} O fragmento, uma prece a Hera, é bastante precário, e suas principais fontes são o \emph{Papiro de Oxirrinco} 1231, rolo em que também se preservaram os Frs.\,15 e 22, e o \emph{Papiro de Milão} \textsc{ii} 123. São nomeados Hera,\footnote{Versos 2 e talvez 20.} Zeus e Dioniso --- ``filho de Tione'',\footnote{Verso 10.} epíteto de Sêmele, a princesa tebana com quem Zeus o gerou e que foi imortalizada, após a morte pela visão do deus em seu terrível brilho e esplendor. Essa junção faz pensar no santuário das três divindades em Messa, em Lesbos. A referência aos Atridas, Agamêmenon e Menelau, por sua vez, traz à prece no presente (11) o mundo do passado mítico de Troia; aos Atridas remontaria a fundação do culto lésbio à deusa invocada na canção, quando de seu regresso de Troia a Argos. E as referências a algo sagrado e a moças virgens
fazem pensar em algo relativo ao culto no contexto de um exílio, considerando que talvez Zeus receba no verso 9 o epíteto cultual \emph{antaîos}, ``dos suplicantes'', que Alceu, o poeta lésbio contemporâneo a Safo, e por duas vezes exilado, confere ao deus no Fr.\,129; e no templo de Hera ele vê um concurso de beleza no Fr.\,130\textsc{b}. Diga"-se, por fim, que o nome da deusa\footnote{Verso 4.} e ``festividade'', \emph{eórtan},\footnote{Verso 3.} são as únicas palavras legíveis do Fr.\,9, indicativas de culto a Hera, como um pouco melhor vemos neste Fr.\,17.}
...
\begin{verse}
\textls[-15]{\ldots{} elas [as Musas] me fizeram honrada, suas próprias}\looseness=-1\\
obras me doando \ldots{}
\end{verse}

\medskip

{\paragraph{Comentário} A fonte do fragmento é \emph{Sobre os pronomes} (144\textsc{a}), de Apolônio
Díscolo, gramático que, noutro tratado, preservou também o já visto Fr.\,33. O
gênero feminino do \emph{eu} e a menção de seus \emph{érga }, ``trabalhos'', como
``dons'' que a tornam honrada levam a pensar que o sujeito feminino
coletivo no pronome \emph{aí}\footnote{Verso 1.} deve ser divino --- deve ser o conjunto das Musas. Logo, tais dons
...
{\paragraph{Comentário} Preservado em Heféstion, como o 102, o fragmento nomeia a líder das Musas, ``Bela Voz'', como a retrata Hesíodo no catálogo de seus nomes.\footnote{\emph{Teogonia}, versos 77--80.}}
...
verso inaugural de um \emph{hino clético }às Musas, invocadas a deixarem,
...
{\paragraph{Comentário} De acordo com a fonte, Máximo de Tiro,\footnote{\emph{Oração} 18.} que também preservou o Fr.\,47, anteriormente traduzido, ``Sócrates ficou bravo com Xantipe que se
lamentava enquanto ele morria'', em referência ao final do \emph{Fédon}, de
...
escapa à restrição, pois há em seu \emph{corpus} ao menos um canto lamentoso
...
do tipo que se percebe no Fr.\,150. Lembre"-se que a \emph{Ilíada},
...
].ατε τὰν εὔποδα νύμφαν [\\
].τα παῖδα Κρονίδα τὰν ἰόκ[ολπ]ον [\\
].ς ὄργαν θεμένα τὰν ἰόκ[ολ]πος α[\\
 ].. ἄγναι Χάριτες Πιέριδέ\,[ς τε] Μοῖ\,[σαι\\
     ].[. ὄ]πποτ’ ἀοιδαι φρέν[...]αν.[\\
             ]σαιοισα λιγύραν [ἀοί]δαν\\
         γά]μβρον, ἄσαροι γὰρ ὐμαλικ[\\
  ]σε φόβαισι θεμένα λύρα .[\\
  ]..η χρυσοπέδιλ[ο]ς Αὔως
\end{gkverse}

\begin{verse}
\ldots{} a noiva de belos pés \ldots{}\\
\ldots{} a filha de colo violáceo do Cronida \ldots{}\\
\ldots{} a raiva pondo \ldots{} a de violáceo colo \ldots{}\\
\ldots{} sacras Cárites e Piérias Musas \ldots{}\\
\ldots{} quando \ldots{} canções \ldots{}\\
\ldots{} clara canção \ldots{}\\
\ldots{} noivo, pois atrevidos coevos \ldots{}\\
\ldots{} cachos, pondo a lira \ldots{}\\
\ldots{} Eos de áurea sandália \ldots{}\\
\end{verse}

\medskip

\paragraph{Comentário} Preservado  no \emph{Papiro de Oxirrinco} 2294 (século \textsc{ii} d.\,C.), o fragmento traz, explica a fonte, dez versos de abertura de dez distintas canções, mencionando vários deuses: uma não identificável filha de Zeus, o filho de Crono; as Cárites; as Musas Piérias e Eos. Traduzo os mais legíveis, como é sempre o caso nesta antologia, dos quais o primeiro e o sétimo podem ser de epitalâmios, espécie mélica de que vimos o Fr.\,112, e outros ainda veremos.
Noto, quanto ao verso inicial, que traz os mesmos termos (\emph{eúpoda nýmphan}), na mesma sequência e declinação em que se acham no Fr.\,103\textsc{b}, no qual só se lê ainda uma palavra, ``quarto nupcial'', \emph{thalámō}.
...
imagens épicas e líricas do casal na \emph{\MakeUppercase{I}líada} e em \MakeUppercase{S}afo (\MakeUppercase{F}r.\,44 Voigt)''.
\emph{\MakeUppercase{C}alíope} 15, 2006, pp.\,36--63.}}
...
\textnormal{[\emph{alguns versos perdidos}]}\\
...
\paragraph{Comentário} Esse fragmento, cujas fontes são os \emph{Papiros de Oxirrinco} 1232 e 2076,\footnote{Primeiras metades dos séculos \textsc{iii} e \textsc{ii} d.\,C., respectivamente.} leva"-nos à saga
de Troia e a personagens que vemos principalmente na \emph{Ilíada}: o arauto
...
``glória imperecível'', \emph{kléos áphthiton}, síntese do ideal heroico a alcançar, a
ser preservado no canto épico, recorda a \emph{Ilíada },\footnote{Canto \textsc{ix}, verso 413.} 
...
crucial que lhes atribui novo \emph{status} social --- o de esposa --- e gera
...
Vale observar o tom em crescendo da festa, com mistura de cantos, instrumentos de sopro, \emph{aulo}, e percussão, \emph{crótalo}, de líquidos --- nas ``crateras'',\footnote{\emph{Krátēres}, verso 29.} grandes jarros de larga boca, vinho misturado à água --- e arômatas  --- entre eles, o incenso,\footnote{\emph{Líbanos}, verso 30.} mencionado pela primeira vez, produto semítico ---, que termina no apogeu da celebração dos noivos sob os auspícios de um canto a Apolo, o \emph{peã} em que se integra a cidade e com o qual louva o deus do arco e flecha --- da guerra que devastará a cidade e destruirá essa boda tão alegremente celebrada ---, e o deus da lira que favorece a música, os cantos, a festa do tempo presente. 
...
da \emph{Ilíada} uma das cenas mais comoventes de despedida
...
pelas mãos de Aquiles, que já haviam matado o pai e os irmãos de Andrômaca; Aquiles cuja sombra parece pairar sobre a canção, na expressão ``glória imperecível'', que profere na \emph{Ilíada} e que o fragmento sáfico enuncia pela boca de Ideu, e na palavra final da canção que termina, no texto grego e na tradução, com o adjetivo ``aos deuses símeis'', \emph{theoeikélois}, dado aos noivos em Safo, mas ao herói grego na \emph{Ilíada}.\footnote{\textsc{i}, verso 131; \textsc{xix}, verso 155.}
...
E todos eles\\
seguravam cálices,\\
e libavam, e auguraram bons votos ao noivo \ldots{}
\end{verse}

\medskip

\paragraph{Comentário}
Ateneu (séculos \textsc{ii--iii} d.\,C.), \emph{Banquete dos eruditos} (10.425\textsc{cd}, 475\textsc{a}) é a principal fonte do fragmento. A cena  do  banquete nupcial pode ser da boda da Nereida Tétis e do mortal Peleu, pais de Aquiles, o grande herói grego da Guerra de Troia e da epopeia homérica \emph{Ilíada}. Ateneu afirma, antes da citação, que ``Alceu introduz Hermes como um servidor de vinho dos deuses, exatamente como Safo''. Note"-se a referência ao alimento dos deuses, ambrosia, \emph{ambrosías}, e a fusão do divino ao mortal na imagem do banquete em que o alimento dos deuses é objeto do verbo ``vinhoverteu'', \emph{eoinokhóēse},\footnote{Verso 3.} que encerra em si o líquido mais nobre dos mortais --- verbo visto já na festividade em espaço sacroerótico do Fr.\,2, em que Afrodite e néctar se combinam no vinhoverter nas taças.
...
agora no plural, o termo ``companheira'', \emph{étaira}, já visto no
126, desta vez ligando o \emph{eu} poético aos nomes de duas figuras míticas: a mãe de
...
estreitamente associadas, tanto pelo termo \emph{étairai}, quanto pelo
...
\textnormal{[\emph{versos 12--4: ilegíveis e lacunares}]}
...
\textnormal{[\emph{versos 23--31: 23--7 perdidos, 28--31 ilegíveis e lacunares}]}
...
ambiguidade que já caracteriza o olhar para a personagem naqueles poemas épicos também se verifica no Fr.\,16 de Safo: Helena é o \emph{exemplum} da afirmação da estrofe inicial sobre o \emph{tò kálliston}, ``a coisa mais bela'', mas é aquela que quebrou os contratos sociais mais relevantes de seus papéis de filha e esposa, pois abandonou pais e marido ``o mais nobre'', \emph{tòn\ldots{} áriston},\footnote{Verso 8.} talvez sob coação divina, se Afrodite é personagem da terceira estrofe. Tais crimes são lembrados por Alceu, o poeta lésbio contemporâneo a Safo, em similar dicção no Fr.\,283, que sobretudo condena Helena pela Guerra de Troia e seus incontáveis mortos, tal qual faz no Fr.\,42, mas enfocando outros elementos. Merece atenção, ainda, a
oposição \emph{éros}--guerra, sobre a qual se elaboram os versos, e a
...
A fonte do fragmento, \emph{Papiro de Oxirrinco} 1231, é a mesma dos Frs.\,15, 17 e 22.
A jovem distante, não mais em Lesbos, parece ser uma das coreutas da associação coral de Safo, uma das \emph{parthénoi}, das moças, cuja partida pode coincidir com sua transição ao mundo do casamento. Resta a memória de sua beleza e graça, canta a canção que a celebra.
...
\textnormal{[\emph{versos 24--5: ilegíveis e lacunares}]}
...
\textnormal{[\emph{versos 30--2: ilegíveis e lacunares}]}

[\qquad			]ες τὸ Γεραίστιον\\
    {[}\qquad			   {]}ν φίλαι

\textnormal{[\emph{versos 35--6: ilegíveis e lacunares}]}
\end{gkverse}
...
{\paragraph{Comentário} O texto, preservado no \emph{Papiro de Berlim} 9722 (século \textsc{vi}
...
em que estão separadas essas duas personagens, \emph{ela} encontra"-se na Lídia --- Sárdis, sua cidade mais importante, talvez no v.\,1 já seja nomeada ---, onde sua beleza é proeminente, como provavelmente o fora em Lesbos, quando lá viveu junto ao grupo coral de Safo. No entanto, \emph{ela} sofre, saudosa de ``Átis''\footnote{Verso 17.} --- talvez o \emph{tu} da canção ---, cuja figura a recordação lhe traz, fazendo
...
\begin{verse}
Eu te desejei, Átis, há tempos, um dia \ldots{}\\[2mm]
...
\begin{gkverse}
\textnormal{[\emph{versos 1--4 e 28: ilegíveis e lacunares}]}
...
{\paragraph{Comentário} Tendo por fonte o \emph{Papiro de Oxirrinco} 2290 (fim do século \textsc{ii} ou início do \textsc{iii} d.\,C.), o fragmento traz a \emph{persona} a expressar volição e falar a um \emph{tu} feminino, afirmando que tipo de amizade é capaz de oferecer, no reiterado uso do verbo \emph{phileîn}, ``amar'', e do termo ``amiga'', \emph{phíla}. Algo de prazeroso se mescla a algo amargo e dolorido; e no último verso pode haver 
referência à caçadora deusa virgem, Ártemis.}\footnote{Campbell, 1994, p.\,113.} 
\textls[10]{Há insistência, por fim, em que a destinatária saiba de algo que não se revela, e a menção do esquecimento. Difícil somar as partes, mas há na base dos versos  uma relação de amizade entre figuras femininas --- uma das quais, a \emph{persona} ---, e talvez uma ruptura.}
...
\textnormal{[\emph{versos 28--9: ilegíveis e lacunares}]}
\end{gkverse}
...
reencenar a separação entre o \emph{eu} --- ``Safo'' --- e \emph{ela}, revivida em
...
ao fim ainda legível do fragmento em que se destaca a coralidade própria à natureza do grupo de \emph{parthénoi}, de meninas virgens, liderado por Safo. Grupo em que dança, canto, atividades de culto e corais, a preparação para o \emph{gámos}, ``casamento'', e para a atuação no mundo do sexo faziam parte do que podemos chamar de \emph{paideía}, ``formação'' feminina. Grupo do qual já se acham distantes, na Lídia, as \emph{parthénoi} dos Frs.\,16 (Anactória) e 96, e a \emph{parthénos} cuja despedida a canção relata em chave consolatória --- o consolo a quem partiu e a quem ficou na memória feliz da coralidade compartilhada, da beleza, do prazer e do convívio com as amigas, de uma vida que, ao casar"-se e tornar"-se mulher, \emph{gyné}, deixa para trás.

\textls[-10]{Merece atenção a frequência do convite ao passado em Safo nesses Frs. 16, 94 e 96, o qual ``tem valor ideológico: nos momentos de fratura'', quando uma das jovens se separa do grupo ao mudar de \emph{status}, ``a poeta exorta a criar uma ponte entre passado e futuro, que mantenha viva a relação de companheirismo através da recordação. Esta operação tem um duplo significado: de um lado, consola quem parte e quem fica; de outro, reafirma os princípios constitutivos da comunidade, recordando"-lhe os valores e as atividades''.}\looseness=-1\footnote{Caciagli, 2009, p.\,78.}
\textls[-10]{Ressalto, enfim, a força do tema da memória (e do esquecimento), marcado já no Fr.\,1, e que mesmo noutros fragmentos aqui não incluídos, como o 24 e 25, estaria presente, se aceitarmos a possibilidade de que, em seus respectivos e ilegíveis textos, haja formas verbais relativas ao lembrar ou esquecer.
}\looseness=-1}
...
% {\paragraph{Comentário} Preservado na \emph{Antologia} (3.4.12) de Estobeu (século \textsc{v} d.\,C.), o fragmento traz um dos muitos momentos em que os poetas refletem em seus versos
...
% invectiva, e dirigida a um \emph{tu} feminino que pensa ser (hábil) poeta, mas
...
\begin{verse}
\ldots{} e de mim tens esquecimento \ldots{}\\[2mm]
...
{\paragraph{Comentário} Preservado em Dio Crisóstemo (séculos \textsc{i--ii} d.C),\footnote{\emph{Oração} (37.47).} o fragmento talvez expresse a confiança na imortalidade por parte da poeta, em sua \emph{persona} dramática, em canção.}
...
\begin{gkverse}
\textnormal{[\emph{versos 1--3 e 14--6: ilegíveis e lacunares}]}
...
\emph{Papiro de Berlim }9722, também fonte dos Frs.\,94 e 96. Ressalto a imagem do
rio do mundo dos mortos, o Aqueronte mencionado no Fr.\,65, cujas margens são usualmente pintadas
como densas de flores de lótus, flores desde a tradição egípcia associadas à morte. O \emph{eu} feminino parece dirigir"-se a um deus,
...
\begin{verse}
\ldots{} mas grato me sendo, toma o leito de {[}outra{]} mais\qb{}nova,\\
\textls[-10]{pois não suportarei ser a mais velha numa parceria \ldots{}}\looseness=-1
\end{verse}

\medskip

{\paragraph{Comentário} Preservado em Estobeu (4.22.112), como o Fr.\,55, o 121 trabalha com a ideia da
reciprocidade, importante ao imaginário grego; o \emph{eu} feminino fala a um \emph{tu}
...
\paragraph{Comentário} \textls[-15]{A fonte é o \emph{Etimológico genuíno }(século \textsc{ix}). O termo empregado para
``companheira'', \emph{etaíras}, usado no Fr.\,142, marca uma amizade e aliança muito estreita entre o \emph{tu}
e \emph{ela}, e indica serem coetâneas essas personagens. O modo como o desejo é expresso parece acrescentar a essa relação o
ingrediente erótico, que de modo algum seria estranho ao convívio na associação coral feminina das \emph{parthénoi}, as virgens. Se o \emph{tu} referir uma delas, o íntimo convívio compartilhado pode estar em cena, como está no Fr.\,94 e no catálogo de belezas desfrutadas na coralidade, que lá se desenha.}\looseness=-1
...
\paragraph{Comentário} O foco nos olhos é comum quando se canta a beleza; nesse canto, o \emph{eu} chama o
\emph{tu} de \emph{phílos}, ``amigo'', termo que pode ou não ter conotação
...
{\paragraph{Comentário} O Fr.\,31 ou \emph{Phaínetaí moi}, ``Parece"-me\ldots{}'', tem por fonte
principal o famoso tratado \emph{Do sublime}.\footnote{10.1--3, século \textsc{i} d.\,C.?, \emph{Longino}.} Ao
...
F. (trad., introdução, notas). \emph{Longino.} \emph{Do Sublime.} São
...
A cena retratada eroticamente produz uma triangulação na qual o olhar do \emph{eu}
feminino contempla primeiramente um homem que se porta como audiência de um
\emph{tu} feminino, para depois concentrar"-se na contemplação dessa
...
a.\,C.) no \emph{Poema 51},\footnote{ Cito"-o, em tradução de Oliva (1996):
\emph{Ele parece"-me ser par de um deus,/ Ele, se é fás dizer, supera os
...
\paragraph{Comentário} \textls[-10]{Nesse parco fragmento preservado, como o Fr.\,126, no \emph{Etimológico genuíno}, combina"-se um binômio recorrente na poesia erótica grega:
...
no diálogo \emph{Fedro}, por exemplo.}\looseness=-1
...
{\paragraph{Comentário} Preservado na \emph{Carta a Jâmblico} (183), nome do filósofo neoplatonista do
...
\emph{éros}: o de que paixão é fogo; logo, sua satisfação é como o apagar de
um incêndio, como diz o \emph{eu} feminino ao \emph{tu}, abaixo.}
...
fonte do fragmento é o tratado \emph{Das negativas} (23), de Crísipo (filósofo
...
\paragraph{Comentário} \textls[-10]{Eis o que de legível há no texto corrompido do fragmento citado por Herodiano (fins do século \textsc{ii} d.\,C.), no tratado \emph{Sobre palavras anômalas} (\emph{beta} 39), que o atribui ao Livro \textsc{ii} da compilação alexandrina da obra de Safo, e com ele ilustra a palavra \emph{týle}, ``almofada'', em que a \emph{persona} talvez repouse o corpo. Mesmo em tão exíguo texto vemos a dimensão profundamente sensorial, tátil aqui, da dicção sáfica, cuja força está evidenciada nas canções.}\looseness=-1
...
{\paragraph{Comentário} Tendo por fonte o \emph{Papiro de Oxirrinco} 1787, o mesmo do Fr.\,65, o 63 tem seu início preservado, com invocação em prece a Ôneiros, o deus Sonho, que move o sonho, \emph{ónar}, referido antes no Fr.\,134, e se associa ao sono ou ao deus que é seu soberano --- \emph{Hýpnos} é o nome de ambos. Este ou aquele deus é qualificado como \emph{glýkys}. ``doce'',\footnote{Verso 3.} e perturbações emocionais e expectativa compõem a cena que não podemos recompor.}
...
\begin{verse}
\ldots{} quando [o sono] de noite afora captura os seus \qb{}{[}olhos{]} \ldots{}
\end{verse}

\medskip

{\paragraph{Comentário} Citado pelo gramático Apolônio Díscolo na discussão sobre pronomes, mesma fonte do Fr.\,32, o 149 traz apenas um verso que de novo canta o que se desenrola no correr da noite, \emph{pánnykhos}, como antes o Fr.\,23, e outros adiante.}
...
\medskip
 ...
 \paragraph{Comentário} \textls[15]{Citado no \emph{Etimológico Magno} (século \textsc{xii}), no verbete do termo sinônimo a \emph{hýpnos}, \emph{áōros}, o fragmento tem só um verso, sobre o sono, como o anterior.}
...
\begin{gkverse}
\textnormal{[\emph{versos 1 e 22--5: ilegíveis e lacunares}]}
...
\textnormal{[\emph{versos 14--9: ilegíveis e lacunares}]}
...
{\paragraph{Comentário} Tendo por fonte o \emph{Papiro de Oxirrinco} 1231, o mesmo do Fr.\,15, o 20 traz uma viagem marinha difícil, ou usa essa imagem para falar das perturbações políticas da \emph{pólis}, no motivo conhecido como da ``nau do Estado''. Mas tão precário texto não permite navegar num ou noutro sentido com segurança.}
...
\paragraph{Comentário} \textls[-10]{A principal fonte desse fragmento concentrado no corpo celeste feminino da lua, antes cantada no Fr.\,96, é
um comentário de Eustácio (bispo de Tessalônica, século \textsc{xii} d.\,C.) à
\emph{Ilíada},}\looseness=-1\footnote{\textsc{viii}, 555.} \textls[-10]{em passo sobre o brilho dos astros no enredor da destacada lua.}\looseness=-1
...
(\emph{Ode pítica} 1), poeta mélico da virada dos séculos \textsc{vi}--\textsc{v} a.\,C.,
...
\begin{verse}
\textls[-15]{Por que, ó Irene, a Pandionida, a andorinha a mim \ldots{}?}\looseness=-1
\end{verse}

\medskip

{\paragraph{Comentário} Citado em Heféstion, fonte do Fr.\,102, o 135 dirige"-se a Irene, também mencionada no Fr.\,91, para falar ``da filha de Pandião'', mítico rei de Atenas, chamada Procne, que se transformou em andorinha. Esposa de Tereu, rei da Trácia, e irmã de Filomela, que se transformou em rouxinol. Na tradição, conta"-se que Tereu, desejando"-a, violou a cunhada e por isso as irmãs dele se vingaram, matando Ítis, o próprio filho de Procne com o rei. Daí o canto triste da andorinha, ave que a \emph{persona} canta.}
...
\begin{verse}
\ldots{} mensageiro da primavera, o rouxinol de desejável\qb{}voz \ldots{}
\end{verse}

\medskip

\paragraph{Comentário} Segundo a fonte do fragmento, um escólio a Sófocles (século \textsc{v} a.\,C.) e à \emph{Electra},\footnote{Verso 149.} Safo já falava como na tragédia dos
rouxinóis.
...
cita como proverbiais estas palavras de Safo, no tratado \emph{Figuras de expressão} (25).
Notáveis são as reiterada assonâncias e aliterações na sequência de palavras, que costuram as sílabas pelo sentido e pelo som; translitero o verso: \emph{méte moi méli méte mélissa}.
...
ilustram isso --- aqueles que estão mais legíveis no \emph{corpus} de Safo.
\end{argumento}
...
\begin{gkverse}
\textnormal{[\emph{versos 1--2 e 14: ilegíveis e lacunares}]}

]ν δ’ εἶμ’ ε[\\

\textnormal{[\emph{versos 4--8: ilegíveis e lacunares}]}\\
...
{\paragraph{Comentário} Preservado no \emph{Papiro de Oxirrinco} 1787, fonte do Fr.\,65, o 70 traz poucas palavras nos versos precários. Destaco \emph{harmonía} e \emph{khorón}, o coro que dança e, por extensão, canta, possivelmente referente ao coro de Safo que faz a \emph{performance}.}
...
{\paragraph{Comentário} Preservado no \emph{Sobre os tipos de estilo} (2.4), de Hermógenes (século \textsc{ii} d.\,C.),
...
{\paragraph{Comentário} Citado por Atílio Fortunato (metricista, século \textsc{iv} d.\,C.), na sua \emph{Arte} (28), o fragmento tem apenas duas palavras que trazem aos olhos e ouvidos a \emph{performance} do coro de meninas de Safo, ao destacar a habilidade de uma \emph{parthénos}, uma das moças, e o prazer erótico, sensorial de sua voz \emph{adýphōnon}.}
...
companheiras deleites belamente cantarei
\end{verse}

\medskip

\paragraph{Comentário} A fonte do fragmento, como do 141, é Ateneu (13.571\textsc{d}). Nele ocorre o termo ``companheira'', \emph{étaira}, no plural.
Para alguns, esse termo em Safo levou à leitura de que a poeta estaria associada a uma \emph{hetaireía} feminina. Tratar"-se"-ia de um grupo aristocrático de iguais, ligados por laços de amizade e políticos. Porém, conforme enfatizei na introdução, não há nenhuma evidência de que existiria esse tipo de confraria típica do universo masculino no feminino; deslocá"-la a este é movimento de espelhamento carente de fundamentação. Logo, o que de mais seguro podemos dizer é que o termo, marcadamente afetivo, denota uma relação amistosa entre coevos, e é usado também nos Frs.\,126 e 142. Neste Fr.\,160, como no 126, indicaria uma fala dirigida às coreutas do grupo de Safo; e a \emph{persona} é decerto uma delas falando às amigas, suas iguais. Fica anunciada, em chave metalinguística, a bela \emph{performance}
de uma canção prazerosa às suas audiências interna e externa.

\begin{argumento}
\textls[-10]{O elogio e a censura consistem num dos pares opostos mais trabalhados na poesia
...
elogio, outros na
censura. Mesmo alguns textos demasiado mutilados e lacunares, com poucas palavras legíveis, parecem caminhar no sentido do binômio e de seus polos, como os Frs.\,3 e 4 --- naquele, há referências à nobreza e beleza, à vileza, dores e ``censura'', \emph{óneidos} (v.\,5); neste, talvez à beleza do ``rosto'' (v.\,7) e ao ``brilho'' (v.\,6). O poder de um e de outro só pode ser
...
definição repercute na sua linhagem e na sua comunidade.}\looseness=-1
\end{argumento}
...
\paragraph{Comentário} \textls[-15]{Apolônio Díscolo,}\looseness=-1\footnote{\emph{Sobre os pronomes} 124\textsc{c}.} \textls[-15]{fonte dos Frs.\,32 e 33, cita os versos acima.
As destinatárias são elogiadas, e provavelmente os pensamentos são positivos e talvez expressem como a \emph{persona} as vê.}\looseness=-1
...
também louvada por um adjetivo, ``tenra'', \emph{apálas}, de marcada
...
\end{quote}
 ...
 da menina virgem, filha da deusa Deméter, e da virgem ``tenra'', \emph{apálan}, de modo a ressaltar nesta a beleza e a
 sensualidade. Vale lembrar que Perséfone, como conta o \emph{Hino homérico a Deméter} 
 ...
 espreitam as belas e sensuais meninas virgens, \emph{parthénoi}. Cabe frisar, como fiz na introdução, que a virgindade delas,
...
\begin{argumento}
Não temos no \emph{corpus} da mélica sáfica textos pertencentes ao gênero
...
mas integra vários da poesia grega antiga, desde a \emph{Ilíada}. Eis
...
\paragraph{Comentário}
Preservado no precário \emph{Papiro de Berlim} (século \textsc{vii} d.\,C.), somado ao \emph{Papiro de Oxirrinco} 424 (século \textsc{iii} d.\,C.), o fragmento parece falar de amizade, de censura, \emph{óneidos}, em vexar --- e nessa atmosfera se inserem a \emph{persona} que é"-nos opaca tanto quanto o \emph{tu} indicado na  forma verbal do verso 4 (\emph{lýpēs}), e reflete sobre o bom/\,belo, \emph{kalós}, o nobre, \emph{esthlós}, e o feio/\,vil, \emph{kakós}, noções ético"-estéticas muito caras ao pensamento arcaico e seus valores tradicionais.
...
\begin{verse}
\textls[-15]{\ldots{} não imagino que uma virgem, após ver a luz do sol,}\looseness=-1\\
...
poética de uma virgem, \emph{parthénos}, que em vida estaria condenada à
mediocridade.}
...
duramente censurados, Ateneu (1.21\textsc{bc}), fonte também do Fr.\,141, declara: ``Safo
...
\textnormal{[\emph{versos 1--2 e 4--7: ilegíveis e lacunares}]}
...
\medskip
\paragraph{Comentário} Preservado no duramente danificado rolo \emph{Papiro de Oxirrinco} 1787, em que se acham o Fr.\,65 e outros, o 68 traz, entre versos que mal se discernem, de novo a figura de Andrômeda, além de uma virgem associada ao grupo e Safo nos testemunhos antigos, Megara.  A linguagem parece lidar com a censura, e refere deuses ao nomeá"-los, \emph{théoisin},\footnote{Verso 3.} e pelo adjetivo \emph{mákaira}, ``venturosa'',\footnote{Verso 6.} que noutros fragmentos traduzi, e que só aos imortais pode ser atribuído --- no Fr.\,1, é dado a Afrodite. No verso 8, há algo talvez sobre o conter da ganância,\footnote{Ferrari, 2011, p.\,158.} a qual é sempre condenada. Noto ainda a presença das Tindaridas, Helena e Clitemnestra, as filhas do rei de Esparta, Tíndaro, e Leda, casal de que falei no comentário ao Fr.\,166. Tal presença reforça a possibilidade de censura, pois as duas figuras míticas femininas sob tal signo se acham, ambas adúlteras, desertora --- aquela --- e assassina --- esta --- de seus respectivos maridos, os filhos de Atreu, Menelau e Agamêmnon. E por fim, veja"-se o adjetivo \emph{ádolon}, ``sem dolo'',\footnote{Verso 11.} que traz para a canção algo que se relacione justamente a um engano, um ardil.
...
fragmento, cuja precária fonte é o \emph{Papiro de Oxirrinco} 1787, o mesmo do Fr.\,65 e de outros, quase nada revela da canção perdida.}
...
\begin{verse}
\ldots{} nunca tendo encontrado outra mais abjeta que\qb{}tu, Irene \ldots{}
\end{verse}
...
\paragraph{Comentário} Aristóteles (século \textsc{iv} a.\,C.), na \emph{Retórica} (1367\textsc{a}), afirma: ``Os homens se envergonham de dizer, de fazer ou de pretender fazer vilezas, exatamente 
...
\begin{verse}
\ldots{} bem saciada de Gorgo \ldots{}
\end{verse}

\medskip

\paragraph{Comentário} \textls[-10]{A fonte desse fragmento é o autor que também preservou o já visto Fr.\,46, Herodiano, no tratado
\emph{Sobre a declinação dos substantivos}. Nele, a personagem feminina é
criticada por uma voz sem qualquer identificação. Mas nos testemunhos, além de Andrômeda, circula também o nome de Gorgo, alvo de censura na canção, como poeta rival de Safo. Não temos evidência dessas poetas rivais que não sejam os testemunhos antigos. Não parece, contudo, implausível que Mitilene tivesse outras poetas líderes de grupos corais, como Safo, dadas as evidências sobre os numerosos  grupos corais femininos disseminados pelas \emph{póleis} gregas.}\looseness=-1
...
rapsodo, \emph{Íon}, ou \emph{Sobre a inspiração poética}. Ora, a ironia
...
Esses traços são muito próprios aos epitalâmios, pois não apenas é continuada a tradição grega de seu canto nos casamentos, mas há neles  ``um marcante nível de continuidade'' (Swift, 2010, p.\,119). Diga"-se ainda que os epitalâmios de Safo aqui apresentados ``exibem, com relação ao rito da boda, uma função pragmática precisa, por articular suas fases e realçar suas principais características'' (Ferrari, 2010, 
p.\,119). 
\end{argumento}

\chapter[Epitalâmios: canções de casamento]{Epitalâmios\subtitulo{Canções de casamento}}
...
trazes ovelha, trazes cabra, arrebatas da mãe a filha\\[2mm]
...
foi preservado na \emph{Oração 46}, de Himério, retórico antes citado no comentário ao Fr.\,112.
...
Noto que Demétrio destaca o uso que faz Safo da repetição --- característica da estilística epitalâmica, diga"-se --- da forma verbal \emph{phérēis}, da qual Vésper é sempre sujeito; uso que considera gracioso, \emph{kharientízetai}. O verbo ocorre uma vez no verso 1 e três vezes no 2, modificado, na última ocorrência, seu sentido modificado pelo termo sucessivo \emph{ápy} --- indicativo de afastamento, \emph{ápo}.\footnote{Em tradição anterior, segui o entendimento de que o verbo ao final diria ``trazes de volta à mãe a criança''. Todavia, adoto novo entendimento aqui, considerando, junto a Ferrari (2010, pp.\,120--1) o que sabemos das etapas da boda e uma passagem no poeta latino Catulo (\emph{Ode} 62, versos 20--23), cujas odes epitalâmicas têm Safo como referente: ``\emph{Héspero, qual no céu é brilho mais cruel/ que tu, que a filha arrancas dos braços da mãe?/ Dos braços da mãe a arrancas, que se agarra,/ e a dás, menina casta, dom ao moço ardente?/ Rasa a urbe, o que mais cruel inimigos fazem?/ Hímen, ó Himeneu, vem Himeneu, Himeneu!}'', trad. Oliva 1996.} }
...
\textls[-15]{não, não o esquecem --- mas não o podem alcançar \ldots{}}\\[2mm]
...
\paragraph{Comentário} \textls[-10]{Citados por Siriano, comentador bizantino do tratado de estilística de
Hermógenes (1.1), e por Demétrio (106), ambos já aqui mencionados respectivamente nos Frs.\,118 e 101\textsc{a}, os fragmentos trazem duas imagens metafóricas distintas: no trio de versos (\emph{a}), a da menina fruta madura, a maçã, sensual, desejada por todos,
mas não a todos alcançável; na dupla (\emph{b}), a da perda da virgindade nas bodas.
Em ambos, é a natureza que alavanca a linguagem erótica.
E na segunda, o casamento faz"-se, como de fato é, uma espécie de morte,}\looseness=-1\footnote{Swift, 2010, p.\,250.} \textls[-10]{porque provoca a transição irreversível de uma vida, a de \emph{parthénos}, ``moça'', para a outra, a de \emph{gyné}, ``mulher''. Como observei no comentário ao Fr.\,44, cujo tema é a boda mítica de Heitor e Andrômaca, são muitos e especificamente gregos os paralelos entre as cerimônias nupcial e fúnebre.}\looseness=-1\footnote{Redfield 1982, p.\,188.}
...
noivo, há seu elogio em chave comparativa com o elevado \emph{status}
...
\emph{Sobre as conjunções} (1.223.24\textsc{ss}.). A virgindade, tema recorrente no epitalâmio, uma
vez que está em evidência sua ruptura no enlace sexual que deve consumar o
casamento, é pensada pelo \emph{eu} que nos fala.
...
{\paragraph{Comentário} Citado em Himério,\footnote{\emph{Oração} 9.} fonte do Fr.\,104, este fragmento traz as palavras de condução do noivo à noiva, no aposento nupcial, informa a fonte, ao qual realçam a beleza dela.}
...
\paragraph{Comentário} Citado em anônimo comentário reunido junto a outros dispersos na coletânea \emph{Anedota Oxfordiana},\footnote{\textsc{i} 190, século \textsc{xix}.} o fragmento surge a propósito de um verso da \emph{Ilíada},\footnote{\textsc{i}, 528.} que com o termo equivalente (\emph{ê}) ao usado por Safo (\emph{êsi}), observa o comentador, expressa o dizer em 3ª pessoa do singular. Nele, há apenas três palavras, ligadas decerto à passagem da noiva de sua própria família à do noivo, pelas mãos do pai.
...
Tal figura tem contraparte real na cerimônia, o escolhido amigo do noivo, o real \emph{thyrōrós}, como é chamado, ressalta Caciagli,\footnote{2009, p.\,68.} que se mantém em vigilância, enquanto os coros e danças prosseguem, do lado de fora do tálamo. Hesíquio (século \textsc{v} d.\,C.), no verbete ao termo em seu \emph{Léxico}, dá \emph{thyrōrós} o sinônimo \emph{paránymphos}, ``o amigo do noivo''. As amigas da noiva começam seu canto jocoso por ele, na figura do monstrinho, zombeteiramente, sublinha\footnote{Ferrari, 2010, pp.\,124--5.} --- a zombaria, a jocosidade sendo da tradição popular das canções de casamento.}
...
\begin{verse}
(\textsc{noiva}) ``Virgindade, virgindade, aonde vais, me\qb{}abandonando?''\\

\medskip

(\textsc{virgindade}) ``Nunca mais a ti voltarei, nunca mais\qb{}voltarei''
\end{verse}

\medskip

{\paragraph{Comentário} Este, como o 101\textsc{a}, tem em Demétrio (140) sua fonte. O canto dialogado, forma já vista
nos Frs.\,133 e 140, é de \emph{performance} coral. Novamente, a canção jocosa
...
idade adulta, em que passa a atuar na esfera do sexo, deixando para trás sua casa, a mãe e as amigas --- a existência de \emph{parthénos}.
...
\paragraph{Comentário} Preservado por Sérvio (século \textsc{iv} d.\,C.), em seu comentário às \emph{Geórgicas} (1.31) de Virgílio (século \textsc{i} a.\,C.), o fragmento saúda os noivos, elogiando"-os.
...
\begin{gkverse}
\textnormal{[\emph{versos 1--3: ilegíveis e lacunares}]}
...
{\paragraph{Comentário} {Preservado no \emph{Papiro de Oxirrinco} 1231, como o Fr.\,15 e tantos outros, o 27 traz uma voz que busca convencer alguém  --- o \emph{tu}
...
Caciagli\footnote{2009, p.\,63.} nota que no fragmento ``afloram quase todos os aspectos que caracterizam a obra da poeta'', como os entrelaçados canto"-dança, \emph{mélpesthai}, e o desejo, \emph{érōs}, entrelaçados, como nos Frs. 22, 94, 96; ``termos conexos à juventude'' das personagens, recorrentes nas canções de Safo; o tema da memória, destacado nesta antologia, indicado no verso 1 (\emph{pote}); e ``a referência à cerimônia nupcial''. Nesse sentido, a linguagem faz"-se reflexo da canção da poeta, e a \emph{persona} faz"-se a líder das meninas do coro --- a \emph{khorodidáskalos}.\footnote{Frisam"-no Caciagli (2009, p.\,64) e Ferrari (2010, p.\,34).}}
...
mas, despertos,\footnote{\textls[-10]{A tradução busca enfatizar o sentido do acordar com o dia, mas é válida ainda a tradução por ``tendo se erguido'' (Ragusa, 2019a, p.\,95). A opção depende do entendimento da celebração noturna (\emph{pannykhís}) do verso 3, que é a ocasião de \emph{performance}:  se sucede o banquete do casamento (Ferrari, 2010, p.\,114), com o coro de moças a chamar o noivo e seus coevos a se erguerem da mesa; ou se é o momento em que o coro vem para o despertar celebrativo matinal dos noivos, ao fim da noite e raiar do dia (Stehle, 1997, pp.\,279--80), como prefiro pensar aqui.}\looseness=-1} os moços solteiros\ldots{}\\
...
\medskip
{\paragraph{Comentário} Tendo por fonte a mesma do Fr.\,27, o 30 igualmente revela uma linguagem muito característica do universo sáfico: a menção de moças virgens, o cantar e a festividade, destacados como temas dos fragmentos nesta antologia. Desse modo, pode"-se pensar como sendo da \emph{persona} da líder do coro, Safo, a
voz que fala ao noivo, como se nota no início e no fim, e da celebração
festiva e ritual noturna, \emph{pannykhís} --- como a do Fr.\,23 ---, nomeada no verso 2, no verbo \emph{pannykhísdoisai}. Em seguida, a \emph{persona} parece concentrar"-se no grupo masculino que do
...
{\paragraph{Comentário} Tendo por fonte o \emph{Papiro de Oxirrinco} 1232, fonte do Fr, 44, o 43 talvez seja destinado a ritualística \emph{pannykhís}, como o anterior e o Fr.\,23. Isso segundo a indicação do último de seus parcos versos que é o final da canção perdida, que fala da aproximação do amanhecer. Ressalto a presença de \emph{phílai}, designando possivelmente as meninas do coro de Safo, responsáveis pela \emph{performance}. A atividade ritual, como enfatizei na introdução e no comentário do Fr.\,94, por exemplo, é de todo compatível e própria às atividades de grupos corais femininos, como atestam os partênios --- as canções para virgens de Álcman, o poeta mélico da Esparta mais ou menos contemporâneo a Safo.}
...
Dica, preparada algo ritualisticamente, é tornada ``ainda mais amável, mais bela, e, portanto, mais desejável''\footnote{Bartol, 1997, p.\,79.} para seu \emph{gámos}, sua boda. A intimidade --- ilusão da dicção sáfica --- da fala à jovem insere a cena possivelmente na preparação da noiva para o banquete nupcial.}\looseness=-1
...
{\paragraph{Comentário} Citado num escólio à comédia \emph{A paz},\footnote{Verso 1174.} 
...
{\paragraph{Comentário} Preservado no \emph{Papiro de Oxirrinco} 1787, fonte do Fr.\,65 e de outros, o 62, cujo início e final são marcados, conjuga elementos que colocam em cena figuras femininas, como parece. Seria o coro o \emph{vós}, e sua líder, a voz em 1ª pessoa do singular? Seriam vestes e a memória de uma jovem já ida o foco?}

\section{Fragmento 92} 

\begin{gkverse}
\textnormal{[\emph{versos 1--2 e 14--6: ilegíveis e lacunares}]}
...
{\paragraph{Comentário} Tendo por fonte o \emph{Papiro de Berlim 9722}, que nos trouxe o Fr.\,96, entre outros, o 92 contém algumas palavras em inícios de versos, mas todas ligadas a vestes e adornos que são objeto de cuidado nos grupos corais femininos e tema de suas canções, como mostram Álcman e seus partênios, e as muitas canções de Safo que já vimos. Chamam a atenção as vestes, seja pelo luxo, expresso no colorido, seja pela forma ou pela maciez --- qualidade que, criando um contraste, marca pelo adjetivo \emph{ábrois'(i)} o pano rústico, \emph{lasíois'(i)}, que bem recobre alguém na linha única e lacunar do Fr.\,100.}
...
{\paragraph{Comentário} Citado num escólio à comédia \emph{As tesmoforiantes},\footnote{Verso 401.} de Aristófanes, o fragmento faz menção a uma das atividades corais mais típicas das associações femininas, mencionada nos Frs.\,81, 94, e a seguir, no 98. O escólio comenta que a prática liga"-se à juventude de mulheres de tempos antigos, como Safo.}
...
{\paragraph{Comentário} Preservado em fontes do século \textsc{iii} a.\,C., o \emph{Papiro de Copenhagen} 301 (\emph{a}) e o \emph{Papiro de Milão} 32 (\emph{b}),
o fragmento é lido em chave biográfica, por conta do
nome de Cleis que, segundo fontes antigas, era filha da poeta; logo, o \emph{eu} seria
...
\emph{mítra}, fita ou faixa adornada que cobria o cabelo, mas não as orelhas,
...
adjetivo derivado do substantivo \emph{poikilía}, que carrega as ideias do
...
justamente por isso associa"-se à sedução erótica e à astúcia. O \emph{eu} lamenta a
incapacidade de dar a Cleis a \emph{mítra}, devido à austeridade projetada no tempo presente, que contrasta com o passado. Que uma fita de cabelo Lídia ``possa chamar tanta atenção como um objeto capaz de perturbar os sonhos de uma jovem menina aristocrática é um dos sinais de um processo de aculturação que se espalhava pelas cidades eólias e jônicas da Ásia Menor e das ilhas próximas''.\footnote{Ferrari, 2010, p.\,5.} Mais: bem pode ser símbolo de \emph{status} e/ou de afinidades políticas. No fragmento, talvez por restrições políticas a \emph{mítra} esteja fora de alcance,  impostas pelo governo do ``mitilênio'', possivelmente
...
{\paragraph{Comentário} Citado em Heféstion (15, 18s.), fonte do Fr.\,102, o 132 é o segundo e último em que vemos claramente o nome de Cleis, que o \emph{eu} introduz como sua filha, louvando-lhe a
beleza da juventude, na imagem das flores de ouro, e afirmando seu valor único no termo \emph{agapáta}, ``amada, querida'' --- que denota o que deve bastar ao contentamento. Por ela, nenhuma troca poderia ser feita, indica a elaboração do verso 3, nem pelo reino mais rico em ouro (a Lídia), nem, talvez, pela terra"-mãe, Lesbos.}
...
\begin{gkverse}
\textnormal{[\emph{versos 1 e 13--5: ilegíveis e lacunares}]}

ὄ]ττινα[ς γὰρ\\
εὖ θέω, κῆνοί με μά]λιστα πά[ντων\\
σίνονται

\textnormal{[\emph{versos 5--6: ilegíveis e lacunares}]}
...
\paragraph{Comentário} A fonte do fragmento é o \emph{Papiro de Oxirrinco} 1231, como também do Fr.\,15. O que se lê parece centrar"-se numa discussão de caráter ético"-moral
a partir da experiência do \emph{eu} feminino que se mostra consciente da dolorosa
...
\begin{verse}
\ldots{} em minha dor \ldots{}\\[2mm]

\hspace*{16mm}[...]\\[2mm]

\ldots{} a ele que me censura, que o carreguem ventos e\qb{}anseios \ldots{}
\end{verse}

\medskip

{\paragraph{Comentário} A fonte é o tardio \emph{Etimológico genuíno}, como é o caso do 126. Dor e
...
{\paragraph{Comentário} Na \emph{Exortação à aprendizagem} (8.16), Galeno (século \textsc{ii} d.\,C.) cita esses dois versos
...
{\paragraph{Comentário} A fonte desse fragmento, como do 144, é Herodiano, no tratado \emph{Sobre
palavras anômalas} (2.912). Nele, o \emph{eu} afirma"-se consciente dos limites próprios da
...
\emph{Papiro de Oxirrinco} 1787, que preservou o 65, constam de outra, Ateneu (15.687\textsc{b}), que também cita o já visto Fr.\,141. Após a publicação em 2004 do
...
trazem uma noção muito cara à mélica sáfica, da \emph{habrosýnē}, ``delicadeza'', de entranhada sensualidade em dimensão de sentido
...
sob o signo de tais marcas. Note"-se a imagem do \emph{éros} do sol, que denota o desejo de viver, de vida, na solução para a tradução que me parece mais interessante ao contexto de citação.}
...
{\paragraph{Comentário} É fonte do fragmento o \emph{Etimológico magno} (2.43); nele, o \emph{eu} explica sua disposição.}
...
\begin{verse}
\textls[-15]{\ldots{} a riqueza sem a excelência não é vizinha inofensiva,}\looseness=-1\\
mas a mistura de ambas traz a mais alta ventura \ldots{}
\end{verse}

\medskip

{\paragraph{Comentário} Um escólio a Píndaro\footnote{\emph{Ode olímpica} 2, verso 96\textsc{b}.} cita o fragmento,
...
{\paragraph{Comentário} No tratado \emph{Sobre o refrear da cólera} (456\textsc{e}), Plutarco, fonte do Fr.\,49, cita o 158 como um conselho de Safo diante da seguinte situação:
...
digno do que a quietude, como exorta (\emph{paraineî}) Safo. 
\end{quote}}
...
\section*{}
\begin{verse}
\ldots{} [das Musas] de violáceo colo os belos dons,\qb{}ó meninas,\\
...
os que um dia foram lépidos no dançar, quais os da\qb{}corça.\\
...
{\paragraph{Comentário} Como observei na anotação ao Fr.\,58, este foi quase totalmente reeditado com a 
publicação, em 2004, do \emph{Papiro de Colônia} 21351 (início do século \textsc{iii} a.\,C.), 
cujo texto se sobrepunha a boa parte daquele fragmento.\footnote{Tradução e comentários embasados na edição do texto grego dada em Buzzi \emph{et al.} (2008, p.\,14) e em Greene e Skinner (2009 pp.\,11 e 14--15), com a possibilidade de alguns suplementos sugeridos por Martin L.\,West (``The new Sappho''. \emph{\textsc{zpe}} 151, 2005, pp.\,1--9), indicados no texto traduzido entre parênteses, como sempre nos fragmentos desta antologia. Tais suplementos são: o nome das Musas no primeiro verso preservado, cujo colo é qualificado; os adjetivos \emph{hápalos} e \emph{lêukai}, para adjetivar como ``tenra'' (\emph{ápalon}) a ``pele'' (\emph{khróa}) e ``brancos'' os cabelos de quem envelhece. As canções do novo papiro foram publicadas pela primeira vez por M.\,Gronewald e R.\,W.\,Daniel (``Ein neuer Sappho-Papyrus''. \emph{\textsc{zpe}} 147, 2004, pp.\,1--8).} No início, a 
linguagem metapoética desenha uma cena de canto junto a ``meninas'', como há que entender o termo \emph{paîdes},\footnote{Verso 1.} considerada a associação liderada por Safo, 
...
ilustrar tal verdade, em passagem gnômica, o \emph{eu} que dramatiza a líder do coro de meninas recorda o
mito da paixão de Eos, a Aurora, pelo jovem mortal troiano Titono, para o qual é nossa fonte
principal o \emph{Hino homérico \textsc{v}, a Afrodite},\footnote{Versos 218--238.} datado do
...
\emph{rhododáktylos}, ``dedirrósea'', no
epíteto composto \emph{brodópakhyn}, no Fr.\,53 atribuído às Cárites.
...
corpo. Digna de nota, por fim, é a ressonância do Fr.\,26 de Álcman no novo de Safo, em que a voz autodramatizada do poeta --- como o é a voz de Safo na canção que traduzo --- canta às \emph{parthénoi}, as virgens de seu coro, a dor de seu próprio envelhecer que o impede de seguir acompanhando"-as nas \emph{performances} das canções.}


\chapter[Canto, velhice: um convite]{Canto, velhice\subtitulo{Um convite}}
...
ou, como no Fr.\,30, uma noiva cujo colo é qualificado pelo adjetivo \emph{iókolpon}, ``de violáceo colo''. Se, porém, não pode a líder cantar, que
...
\chapter[De cantos, cordas, prêmio: a imortalidade?]{De cantos, cordas, prêmio\subtitulo{A imortalidade?}}


\section*{}

\begin{gkverse}
\textnormal{[\emph{versos 1--4: ilegíveis e lacunares}]}

      ] εὔχομ[\\
]. νῦν θαλ[ί]α γε[\\
] νέρθε δὲ γᾶς γε[νοίμα]ν\\
]..ν ἔχοισαν γέρας ὠς [ἔ]οικεν,\\
]ζοεν ὠς νῦν ἐπὶ γᾶς ἔοισαν.\\
] λιγύραν, [α]ἴ κεν ἔλοισα πᾶκτιν\\
        χε]λύνναν.αλαμοις ἀείδω. 
\end{gkverse}
...
{\paragraph{Comentário} Do mesmo papiro que preservou a ``Canção sobre a velhice'' vem, de mais legível, este outro novo fragmento breve, do qual temos os versos finais. Neles, estão presentes festa, o canto da \emph{persona} e instrumentos de corda. Precisamente, a ``harpa'', \emph{pâktin}, que referida no Fr.\,22, e talvez a \emph{khelýnna}, um tipo de lira nomeado pela casca da tartaruga que lhe servia de caixa de ressonância e que designa o instrumento na ``Canção sobre a velhice''.
Tais cordófonos se combinam, ressoando as canções que já aqui ouvimos --- incluindo aquelas que cantam o próprio cantar. O ``prêmio'', \emph{géras}, talvez seja a ``grande fama das Musas'', \emph{kléos méga Moíseion}. No presente da canção, tempo enfatizado por duas vezes, emergem as ideias da morte, do estar sob a terra, e do estar vivo, sobre ela. Haveria no precário texto algo relativo à contemplação de Safo no Hades, morta, e a sua imortalização pela poesia, como vimos nos Frs.\,55, 65 e 147? A resposta seria sim, e decerto, neste caso, ``prêmio'' maior e mais caro não há à poeta que continuamos a cantar.\footnote{Texto grego nas edições dadas em Buzzi \emph{et al.} (2008, pp.\,21 e 57) e Greene e Skinner (2009, p.\,10). As sugestões do suplemento que dá sentido ao ``prêmio'', aceita naquela, e do que traz a \emph{khelýnna} ao verso final, aceita nesta, baseiam-se nos estudos de Gronewald e Daniel, e de West, referidos à nota à ``Canção sobre a velhice''.}}