...
\begin{verse}
Ó Vésper, trazendo tudo que radiante Eos --- a \qb{}Aurora --- espallhou:\\ %ll mesmo?
...
\begin{verse}
\ldots{} (das Musas) de colo violáceo os belos dons, \qb{}crianças,\\
...
os que um dia foram ágeis no dançar, como os da \qb{}corça.

Estas coisas lamento sem cansar, mas que posso \qb{}fazer?\\
Não é possível, sendo homem, ser desprovido da \qb{}velhice.

Pois, certa vez, dizem que Eos, a Aurora de róseos \qb{}braços,\\
com paixão \ldots{} carregando Títono aos confins da \qb{}terra,

belo e jovem que era ele; mas mesmo a ele alcançou \qb{}similarmente\\
a velhice grisalha em tempo --- ele que tinha por \qb{}esposa uma imortal \ldots{}
\end{verse}
