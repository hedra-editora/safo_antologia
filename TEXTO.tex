...
\textls[-13]{Nenhuma outra divindade grega aparece nas canções de Safo com a mesma
frequência, nem do mesmo modo: Afrodite é a mais presente.}\looseness=-1\footnote{ Afrodite é
personagem dos fragmentos 1, 2, 5, 15, 22, 33, 73\textsc{a}, 86, 96, 102, 112, 133, 134
e 140. Neles, o tema da presença da deusa \textit{corpus} foi estudado em Ragusa (2005), em que se baseiam as traduções dos e as notas aos fragmentos legíveis desse \textit{corpus}. Tais traduções, como outras publicadas previamente a esta nova edição da antologia, podem estar aqui ligeiramente alteradas.} \textls[-13]{O fato
...
poética dos versos.}\looseness=-1\footnote{ A diferença é evidente se comparamos a
...
\pagebreak
\paragraph{Comentário} Esse \textit{hino clético} --- prece que invoca a deidade para instá"-la a vir à \EP[1]
...
{\paragraph{Comentário} \textls[-20]{Estamos uma vez mais diante de uma canção"-prece, em prol da obtenção de algo,
...
\paragraph{Comentário} \textls[-15]{Preservado no \textit{Papiro de Oxirrinco} 1787  (século \textsc{iii} d.C.), cujos textos acham"-se muito mutilados, o fragmento traz uma voz que se dirige a Safo e menciona a ilha de Chipre --- referida junto a duas outras localidades}\looseness=-1\footnote{Pafos, na ilha, e Pânormos, na Sicília.} \textls[-15]{na única linha em que consiste o Fr.\,35. Em seguida, talvez mencione sua mais importante deusa, Afrodite, no verso 2, como sua soberana. A ideia do \textit{kléos} --- a glória alcançada por grandes feitos, referida no Fr.\,44, em sua narrativa mítica --- se sobressai e pode estar vinculada à imortalização pela poesia pela fama, talvez o tema do último fragmento traduzido nesta antologia que congrega todas as canções de Safo, exceto pelos ilegíveis. Nesse sentido poderíamos entender a menção de um dos rios do Hades, o mundo dos mortos, no verso final, o Aqueronte, e igualmente a inserção da poeta como personagem dos versos por meio de seu próprio nome, na abertura que resta.}\looseness=-1
...
\paragraph{Comentário} \textls[-15]{Preservado na mesma fonte do Fr.\,65, o 73\,\textsc{a} mostra a \textit{persona} a se dirigir a Afrodite no primeiro verso minimamente legível,}\looseness=-1\footnote{Verso 3.} \textls[-15]{mas nada podemos saber da cena desenhada. O adjetivo \textit{adýlogoi}, ``de doce fala'', no verso 4, talvez qualifique o termo \textit{éros} na forma plural, \textit{érōtes}, que, todavia, não se atesta em Safo.}\looseness=-1
...
\paragraph{Comentário} \textls[10]{Tendo por fonte a mesma do fragmento anterior, o 86 de novo revela a \textit{persona} a falar a Afrodite, nomeada Citereia --- como no Fr.\,140 e em boa parte da poesia grega antiga, pela sua ligação mítico"-cultual com a ilha de Citera ---, e em linguagem muito similar à do Fr.\,1, da segunda estrofe.}\footnote{Versos 5--8.} \textls[10]{É certo que é uma prece, possivelmente um hino clético à deusa, tal qual os Frs. 1 e 2, que igualmente refere Zeus, a quem o epíteto ``porta"-égide'', \textit{aigiókhō},}\footnote{Verso 2.} costuma ser atribuído.
...
\paragraph{Comentário} \textls[-15]{Esse fragmento é de uma canção de casamento ou epitalâmio, como outros no item a essa espécie mélica dedicado nesta antologia, a ser entoado no decorrer dos eventos da cerimônia.
Da importância do epitalâmio no \textit{corpus} de Safo e, mais, no universo em que a poeta e seu coro de \textit{parthénoi} se encontram, falei na introdução e na nota a esta segunda edição deste trabalho, lembrando, entre outras evidências que se somam às próprias canções de Safo, a existência de um livro só de mélica epitalâmica na compilação de sua obra  em Alexandria, na famosa Biblioteca. Recordo ainda testemunhos antigos como o de Himério, retórico do século \textsc{iv} d.C., que diz na \textit{Oração 9},}\looseness=-1\footnote{33--47.} \textls[-15]{ou \textit{Epitalâmio para Severo}, seu aluno: ``[\ldots{}] os ritos de Afrodite foram deixados a Safo de Lesbos, para que os cantasse para a lira e os fizesse para o tálamo. Após os concursos, ela seguia para o tálamo, ornamentava o aposento nupcial, preparava o leito, recrutava as virgens, liderava"-as ao quarto da noiva, e também Afrodite sobre o carro das Cárites --- deusas Graças ---, e o coro de Erotes, companheiro de folguedos''.}\looseness=-1
...
\paragraph{Comentário} \textls[15]{O sonho, como percebido pelos antigos, surge como uma das formas de 
...
\paragraph{Comentário} \textls[-15]{Segundo o viajante grego do século \textsc{ii} d.C., Pausânias, Safo ``sobre
Adônis cantou'';}\looseness=-1\footnote{\textit{Descrição da Grécia}, \textsc{ix}, 29, 8.} \textls[-15]{prova isso o Fr.\,140, 
...
se segue uma indagação; a resposta vem em seguida, dita pela própria Afrodite.}\looseness=-1

\pagebreak	
\textls[-20]{Tal resposta, imperativa, demanda das \textit{kórai}, ``meninas'' ou ``virgens'', a gestualidade fúnebre tradicional do lamento feminino, chamada \textit{góos}), atestada na iconografia e na \textit{Ilíada} \textsc{xviii},}\looseness=-1\footnote{30--1, 50--1.} \textls[-20]{no pranto das servas e das Nereidas pela morte de Pátroclo.
...
\paragraph{Comentário} \textls[10]{Preservados pela mesma fonte do Fr.\,168, como exemplares de métrica de
himeneus, as canções de casamento --- adiante as veremos --- que na
Biblioteca de Alexandria passaram a ser chamadas pelo termo epitalâmio,}\footnote{Literalmente, ``sobre o leito nupcial, o tálamo''.} \textls[10]{as linhas não contíguas (\textbf{a}, \textbf{b}) viriam de uma composição talvez enlaçada ao mito de Adônis, de que falei no
...
epitalâmios ---, pode ser celebratória à beleza do noivo que talvez projete, maximizando"-a. No entendimento da edição Voigt,}\footnote{De 1971.} \textls[10]{as duas linhas de algum modo integrariam o Fr.\,117, epitalâmio de verso único de saudações a noivo e noiva, como se verá na sua tradução, no item dedicado às canções desse tipo.}
...
\paragraph{\textsc{nota introdutória}} 
\textls[-10]{É forte em Safo a temática erótica, mas não tem a mesma presença marcante que
...
\medskip
\paragraph{Comentário} \textls[-20]{A fonte do fragmento é uma \textit{Oração} (18), do retórico Máximo de Tiro (século \textsc{ii} d.C.). \EP[2]
Note"-se como a imagem da tempestade ou ventania violenta é usada para falar de Eros a se abater sobre a \textit{persona}, comprometendo sua estabilidade mental, na medida em que lhe atingi os ``sensos'', \textit{phrénas}.}\looseness=-1\footnote{Verso 2.} \textls[-20]{Veremos sobretudo no Fr.\,31 a síntese do sofrimento erótico, mas já no Fr.\,1}\looseness=-1\footnote{Versos 3--4.} \textls[-20]{se faz presente.}\looseness=-1
...
\paragraph{Comentário} \textls[15]{Segundo a fonte, Pólux,}\footnote{\textit{Onomástico} 10.124, século \textsc{ii} d.C.} \textls[15]{Safo descreve Eros quando canta o verso acima.}
...
\paragraph{Comentário} \textls[15]{A mesma fonte dos Frs.\,47 e 159 preservou como sendo atribuída por Safo a Eros --- o deus ou o desejo --- a seguinte qualificação, coerente com sua imagem.}
...
\paragraph{Comentário} \textls[-10]{Citado por Máximo de Tiro, fonte do Fr.\,47, o 188 traz apenas uma palavra, \textit{mythoplókon}, que teria sido dita sobre Eros por Safo, diz o antigo retórico. O adjetivo pode se referir à eloquência da sedução, potencialmente enganadora, como indicaria o tecer que no mundo erótico tem tal conotação, como vimos no Fr.\,1 e no epíteto \textit{dolóploke} para Afrodite, a ``tecelã de ardis''.}\looseness=-1\footnote{Verso 2.}
...
\paragraph{Comentário} \textls[-15]{Apenas neste fragmento, e no de resto ilegível Fr.\,84, cuja fonte é o \textit{Papiro Fouad} 239 (séculos \textsc{ii} ou
...
virgindade, desejada pela deusa, concedeu"-a Zeus à filha, conta o \textit{Hino homérico a Afrodite} (século \textsc{iv} a.C.), de autoria incerta.}\looseness=-1
...
\begin{verse}
Para cá, ó sacras Cárites de róseos braços, \qb{}meninas de Zeus \ldots{}
\end{verse}\bigskip
...
\paragraph{Comentário} \textls[10]{O destaque ao adorno dos pés enfatiza o erotismo da imagem; pés, braços,
...
\paragraph{Comentário} \textls[-20]{Preservado  no \textit{Papiro de Oxirrinco} 2294 (século \textsc{ii} d.C.), o fragmento traz, explica a fonte, dez versos de abertura de dez distintas canções, mencionando vários deuses: uma não identificável filha de Zeus, o filho de Crono; as Cárites; as Musas Piérias e Eos. Traduzo os mais legíveis, como é sempre o caso nesta antologia, dos quais o primeiro e o sétimo podem ser de epitalâmios, espécie mélica de que vimos o Fr.\,112, e outros ainda veremos.
Noto, quanto ao verso inicial, que traz os mesmos termos (\textit{eúpoda nýmphan}), na mesma sequência e declinação em que se acham no Fr.\,103\textsc{b}, no qual só se lê ainda uma palavra, ``quarto nupcial'', \textit{thalámō}.}\looseness=-1
...
\paragraph{Comentário} \textls[-15]{Esse fragmento, cujas fontes são os \textit{Papiros de Oxirrinco} 1232 e 2076,}\looseness=-1\footnote{Primeiras metades dos séculos \textsc{iii} e \textsc{ii} d.C., respectivamente.} \textls[-15]{leva"-nos à saga
...
chegada do arauto e anúncio da vinda dos noivos Heitor e Andrômaca,}\looseness=-1\footnote{Versos
1--10.} \textls[-15]{e, depois, no espalhar dessa mensagem cidade afora, iniciando"-se com
isso a procissão festiva em honra do casal.}\looseness=-1\footnote{Versos 11--34.} \textls[-15]{A linguagem, a
...
ser preservado no canto épico, recorda a \textit{Ilíada },}\looseness=-1\footnote{Canto \textsc{ix}, verso 413.} 
\textls[-15]{pela boca de seu grande herói, Aquiles.}\looseness=-1
...
\textls[-15]{Ateneu (séculos \textsc{ii--iii} d.C.), \textit{Banquete dos eruditos} (10.425\,\textsc{cd}, 475\,\textsc{a}) é a principal fonte do fragmento. A cena  do  banquete nupcial pode ser da boda da Nereida Tétis e do mortal Peleu, pais de Aquiles, o grande herói grego da Guerra de Troia e da epopeia homérica \textit{Ilíada}. Ateneu afirma, antes da citação, que ``Alceu introduz Hermes como um servidor de vinho dos deuses, exatamente como Safo''. Note"-se a referência ao alimento dos deuses, ambrosia, \textit{ambrosías}, e a fusão do divino ao mortal na imagem do banquete em que o alimento dos deuses é objeto do verbo ``vinhoverteu'', \textit{eoinokhóēse},}\looseness=-1\footnote{Verso 3.} \textls[-15]{que encerra em si o líquido mais nobre dos mortais --- verbo visto já na festividade em espaço sacroerótico do Fr.\,2, em que Afrodite e néctar se combinam no \textit{vinhoverter} nas taças.}\looseness=-1
...
{\paragraph{Comentário} \textls[10]{Tendo por fonte o \textit{Papiro de Oxirrinco} 2290 (fim do século \textsc{ii} ou início do \textsc{iii} d.C.), o fragmento traz a \textit{persona} a expressar volição e falar a um \textit{tu} feminino, afirmando que tipo de amizade é capaz de oferecer, no reiterado uso do verbo \textit{phileîn}, ``amar'', e do termo ``amiga'', \textit{phíla}. Algo de prazeroso se mescla a algo amargo e dolorido; e no último verso pode haver 
referência à caçadora deusa virgem, Ártemis.}\footnote{Campbell, 1994, p.\,113.} 
\textls[10]{Há insistência, por fim, em que a destinatária saiba de algo que não se revela, e a menção do esquecimento. Difícil somar as partes, mas há na base dos versos  uma relação de amizade entre figuras femininas --- uma das quais, a \textit{persona} ---, e talvez uma ruptura.}}
...
{\paragraph{Comentário} \textls[-25]{Preservado no mesmo rolo papiráceo do Fr.\,96, o 94 é fortemente dramático ao
...
\paragraph{Comentário} \textls[-15]{A fonte é o \textit{Etimológico genuíno }(século \textsc{ix}). O termo empregado para
...
ingrediente erótico, que de modo algum seria estranho ao convívio na associação coral feminina das \textit{parthénoi}, as virgens. Se o \textit{tu} referir uma delas, o íntimo convívio compartilhado pode estar em cena, como está no Fr.\,94 e no catálogo de belezas desfrutadas na coralidade, que lá se desenha.}\looseness=-1
...
\paragraph{Comentário} \textls[15]{O foco nos olhos é comum quando se canta a beleza; nesse canto, o \textit{eu} chama o
...
\paragraph{Comentário} \textls[-15]{Nesse parco fragmento preservado, como o Fr.\,126, no \textit{Etimológico genuíno}, combina"-se um binômio recorrente na poesia erótica grega:
...
no diálogo \textit{Fedro}, por exemplo.}\looseness=-1
...
\paragraph{Comentário} \textls[10]{Como no Fr.\,36, temos aqui, possivelmente, o binômio paixão"-loucura, que fratura o amador. A
...
\medskip
 ...
 \paragraph{Comentário} \textls[15]{Citado no \textit{Etimológico Magno} (século \textsc{xii}), no verbete do termo sinônimo a \textit{hýpnos}, \textit{áōros}, o fragmento tem só um verso, sobre o sono, como o anterior.}
...
\paragraph{Comentário} \textls[15]{Heféstion (11.5), referido já no comentário ao Fr.\,102, é a fonte principal do 168\,\textsc{b}, em que a natureza enquadra a imagem da solidão da voz poética, talvez devido a uma separação erótica.}
...
\paragraph{\textsc{nota introdutória}}
\textls[-20]{Como observei ao comentar o Fr.\,96 de Safo, é notável em sua mélica o trabalho
da linguagem com imagens da natureza, de grande presença e força não raro
metafóricas.}\looseness=-1
...
\paragraph{Comentário} \textls[-15]{A principal fonte desse fragmento concentrado no corpo celeste feminino da lua, antes cantada no Fr.\,96, é
um comentário de Eustácio (bispo de Tessalônica, século \textsc{xii} d.C.) à
\textit{Ilíada},}\looseness=-1\footnote{\textsc{viii}, 555.} \textls[-15]{em passo sobre o brilho dos astros no enredor da destacada lua.}\looseness=-1
...
\begin{verse}
\textls[-20]{Por que, ó Irene, a Pandionida, a andorinha a mim \ldots{}?}\looseness=-1
\end{verse}
...
\paragraph{Comentário} \textls[15]{Segundo a fonte do fragmento, um escólio a Sófocles (século \textsc{v} a.C.) e à \textit{Electra},}\footnote{Verso 149.} \textls[15]{Safo já falava como na tragédia dos
rouxinóis.}
...
\paragraph{Comentário} \textls[-20]{O gramático Trifo, da era romana de Augusto (séculos \textsc{i} a.C.--\textsc{i} d.C.), 
cita como proverbiais estas palavras de Safo, no tratado \textit{Figuras de expressão} (25).
Notáveis são as reiterada assonâncias e aliterações na sequência de palavras, que costuram as sílabas pelo sentido e pelo som; translitero o verso: \textit{méte moi méli méte mélissa}.}\looseness=-1
...
\paragraph{Comentário} \textls[-20]{A fonte do fragmento, como do 141, é Ateneu (13.571\,\textsc{d}). Nele ocorre o termo ``companheira'', \textit{étaira}, no plural.
...
de uma canção prazerosa às suas audiências interna e externa.}\looseness=-1
...
\paragraph{Comentário} \textls[-15]{Apolônio Díscolo,}\looseness=-1\footnote{\textit{Sobre os pronomes} 124\,\textsc{c}.} \textls[-15]{fonte dos Frs.\,32 e 33, cita os versos acima.
As destinatárias são elogiadas, e provavelmente os pensamentos são positivos e talvez expressem como a \textit{persona} as vê.}\looseness=-1
...
\paragraph{Comentário} \textls[10]{Heféstion (11.5), citado aqui como fonte do Fr.\,102, preservou o 82\,\textsc{a}, que traz
...
\end{quote}
 ...
 \textls[10]{Ou seja, Ateneu sugere a aproximação entre as imagens
...
\begin{verse}
\textls[-20]{\ldots{} não imagino que uma virgem, após ver a luz do sol,}\looseness=-1\\
...
\pagebreak
\paragraph{Comentário} \textls[-15]{Preservado no duramente danificado rolo \textit{Papiro de Oxirrinco} 1787, em que se acham o Fr.\,65 e outros, o 68 traz, entre versos que mal se discernem, de novo a figura de Andrômeda, além de uma virgem associada ao grupo e Safo nos testemunhos antigos, Megara.  A linguagem parece lidar com a censura, e refere deuses ao nomeá"-los, \textit{théoisin},}\looseness=-1\footnote{Verso 3.} \textls[-15]{e pelo adjetivo \textit{mákaira}, ``venturosa'',}\looseness=-1\footnote{Verso 6.} \textls[-15]{que noutros fragmentos traduzi, e que só aos imortais pode ser atribuído --- no Fr.\,1, é dado a Afrodite. No verso 8, há algo talvez sobre o conter da ganância,}\looseness=-1\footnote{Ferrari, 2011, p.\,158.} \textls[-15]{a qual é sempre condenada. Noto ainda a presença das Tindaridas, Helena e Clitemnestra, as filhas do rei de Esparta, Tíndaro, e Leda, casal de que falei no comentário ao Fr.\,166. Tal presença reforça a possibilidade de censura, pois as duas figuras míticas femininas sob tal signo se acham, ambas adúlteras, desertora --- aquela --- e assassina --- esta --- de seus respectivos maridos, os filhos de Atreu, Menelau e Agamêmnon. E por fim, veja"-se o adjetivo \textit{ádolon}, ``sem dolo'',}\looseness=-1\footnote{Verso 11.} \textls[-15]{que traz para a canção algo que se relacione justamente a um engano, um ardil.}\looseness=-1
...
\paragraph{Comentário} \textls[-15]{Em dado momento das convulsões políticas internas e da sucessão de regimes
...
fragmento, cuja precária fonte é o \textit{Papiro de Oxirrinco} 1787, o mesmo do Fr.\,65 e de outros, quase nada revela da canção perdida.}\looseness=-1
...
\paragraph{\textsc{nota introdutória}}
\textls[-20]{``Em Homero, a canção é um acompanhamento sempre presente no casamento, e a frequente menção de canções nupciais por autores de todos os períodos na literatura grega antiga atesta a continuada importância da canção para a cerimônia de casamento na Grécia antiga''.}\looseness=-1\footnote{Hague, 1983, p.\,131.} \textls[-20]{Na era arcaica, são sáficas as canções que nos chegaram. Assim como o 112, os fragmentos arrolados neste tópico compõem o pequeno grupo
...
Esses traços são muito próprios aos epitalâmios, pois não apenas é continuada a tradição grega de seu canto nos casamentos, mas há neles  ``um marcante nível de continuidade''.}\looseness=-1\footnote{Swift, 2010, p.\,245.} \textls[-20]{Diga"-se ainda que os epitalâmios de Safo aqui apresentados ``exibem, com relação ao rito da boda, uma função pragmática precisa, por articular suas fases e realçar suas principais características''.}\looseness=-1\footnote{Ferrari, 2010, p.\,119.} 
...
\begin{verse}
\textls[-20]{\ldots{} como o mais doce pomo enrubesce no ramo ao alto,}\looseness=-1\\
alto no mais alto ramo, e os colhedores o esquecem;\\*
\textls[-20]{não, não o esquecem --- mas não o podem alcançar \ldots{}}\looseness=-1
...
E na segunda, o casamento faz"-se, como de fato é, uma espécie de morte,}\looseness=-1\footnote{Swift, 2010, p.\,250.} \textls[-10]{porque provoca a transição irreversível de uma vida, a de \textit{parthénos}, ``moça'', para a outra, a de \textit{gyné}, ``mulher''. Como observei no comentário ao Fr.\,44, cujo tema é a boda mítica de Heitor e Andrômaca, são muitos e especificamente gregos os paralelos entre as cerimônias nupcial e fúnebre.}\looseness=-1\footnote{Redfield 1982, p.\,188.}
...
\paragraph{Comentário} \textls[15]{O fragmento tem por fonte Demétrio (146), como o 101\textsc{a}, cujo tratado diz que
...
\paragraph{Comentário} \textls[15]{O gramático Apolônio Díscolo, fonte do Fr.\,33, preservou o 107, no tratado
...
\paragraph{Comentário} \textls[10]{Citado em anônimo comentário reunido junto a outros dispersos na coletânea \textit{Anedota Oxfordiana},}\footnote{\textsc{i} 190, século \textsc{xix}.} \textls[10]{o fragmento surge a propósito de um verso da \textit{Ilíada},}\footnote{\textsc{i}, 528.} \textls[10]{que com o termo equivalente (\textit{ê}) ao usado por Safo (\textit{êsi}), observa o comentador, expressa o dizer em 3ª pessoa do singular. Nele, há apenas três palavras, ligadas decerto à passagem da noiva de sua própria família à do noivo, pelas mãos do pai.}
...
\paragraph{Comentário} \textls[-15]{Também citado em Heféstion (7.1), o fragmento louva a beleza do noivo símil a Ares,
...
\paragraph{Comentário} \textls[10]{Preservado por Sérvio (século \textsc{iv} d.C.), em seu comentário às \textit{Geórgicas} (1.31) de Virgílio (século \textsc{i} a.C.), o fragmento saúda os noivos, elogiando"-os.}
...
\paragraph{Comentário} \textls[15]{Citado por Heféstion (4.2), o fragmento traz conteúdo similar ao do 116.}
...
{\paragraph{Comentário} \textls[-20]{Preservado no \textit{Papiro de Oxirrinco} 1231, como o Fr.\,15 e tantos outros, o 27 traz uma voz que busca convencer alguém  --- o \textit{tu}
...
\end{verse}
\pagebreak
{\paragraph{Comentário} \textls[-15]{Tendo por fonte a mesma do Fr.\,27, o 30 igualmente revela uma linguagem muito característica do universo sáfico: a menção de moças virgens, o cantar e a festividade, destacados como temas dos fragmentos nesta antologia. Desse modo, pode"-se pensar como sendo da \textit{persona} da líder do coro, Safo, a
...
mélico cujos fragmentos acham"-se em tópico próprio.}\looseness=-1}
...
\textls[-20]{pois mesmo as Cárites venturosas voltam-se ao florido,}\looseness=-1\\*
...
Dica, preparada algo ritualisticamente, é tornada ``ainda mais amável, mais bela, e, portanto, mais desejável''\footnote{Bartol, 1997, p.\,79.} para seu \textit{gámos}, sua boda. A intimidade --- ilusão da dicção sáfica --- da fala à jovem insere a cena possivelmente na preparação da noiva para o banquete nupcial.}\looseness=-1
...
{\paragraph{Comentário} \textls[15]{Tendo por fonte o \textit{Papiro de Berlim 9722}, que nos trouxe o Fr.\,96, entre outros, o 92 contém algumas palavras em inícios de versos, mas todas ligadas a vestes e adornos que são objeto de cuidado nos grupos corais femininos e tema de suas canções, como mostram Álcman e seus partênios, e as muitas canções de Safo que já vimos. Chamam a atenção as vestes, seja pelo luxo, expresso no colorido, seja pela forma ou pela maciez --- qualidade que, criando um contraste, marca pelo adjetivo \textit{ábrois'(i)} o pano rústico, \textit{lasíois'(i)}, que bem recobre alguém na linha única e lacunar do Fr.\,100.}}
...
\paragraph{Comentário} \textls[15]{A fonte do fragmento é o \textit{Papiro de Oxirrinco} 1231, como também do Fr.\,15. O que se lê parece centrar"-se numa discussão de caráter ético"-moral
...
{\paragraph{Comentário} \textls[15]{A fonte é o tardio \textit{Etimológico genuíno}, como é o caso do 126. Dor e
...
\begin{verse}
\textls[-20]{\ldots{} a riqueza sem a excelência não é vizinha inofensiva,}\looseness=-1\\
