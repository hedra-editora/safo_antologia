...
antiga}}
\addcontentsline{toc}{chapter}{Introdução, \emph{por Giuliana Ragusa}}
...
distinguindo entre si ---, Safo não é o único nome feminino da poesia da Grécia
	antiga, mas de sua primeira fase histórica, a arcaica\footnote{\textls[-20]{O adjetivo é
		usado no sentido de ``antiga, remota''; a era arcaica é, por assim dizer, a mais
		antiga da Grécia antiga, e divide"-se em duas etapas: a arcaica, até \emph{c.}\,550~a.\,C., e a tardo"-arcaica, \emph{c.}\,550--450~a.\,C.; ver Shapiro (2007, pp.\,1--3) a respeito.}\looseness=-1} (\emph{c.}\,800--480~a.\,C.). Nascida em 630 a.\,C., de família
...
Ambos são os primeiros poetas lésbios dos quais sobreviveram, para cada
...
\emph{mélica} ou a lírica propriamente dita --- a canção destinada à
\emph{performance} em solo ou coral,
com o acompanhamento da lira (e de outros instrumentos e da dança, na
modalidade em coro). Se falo em \emph{performance} é porque, recorde"-se
desde já, sobretudo no período arcaico e depois no clássico (\emph{c.}\,480--323 a.\,C.), pelo menos até \emph{c}.\,400 a.\,C., a poesia grega é eminentemente de tradição oral e inserida no
que John Herington chama de ``cultura da canção'',\footnote{ Herington (1985, p.\,3).} na
qual, recitada ou cantada numa ocasião de \emph{performance}, disseminava
“ideias morais, políticas e sociais”. A oralidade, portanto, marca
a composição e a circulação dessa poesia em \emph{performances} e
\emph{reperformances} profissionais e/ou amadoras a determinada
...
situação de diálogo entre o \emph{performer} e sua audiência, está sempre em
diálogo: em vez de falar consigo mesmo ou a ninguém, o \emph{eu/\,nós} sempre
se dirige ao outro, ao \emph{tu/\,vós} com que estabelece a interlocução. Se por
...
seus poemas monumentais, a \emph{Ilíada} e a \emph{Odisseia}, em que há uma
...
grego, adaptação do fenício, se disseminava desde fins do século \textsc{ix} a.\,C. --- pelos poetas nos processos e técnicas de construção de seus
...
\begin{quote}
\textls[-15]{Um grego que vivesse por volta de 600 a.\,C., se refletisse sobre o problema de
registrar o poema sob a forma escrita, provavelmente consideraria a questão em
termos de uma \emph{transcrição} de algo que já tinha uma existência
...
capaz de fazer isso, sem o auxílio da escrita.}\looseness=-1\footnote{ Svenbro (1993, pp.\,145--59).}
\end{quote}
...
\textls[-15]{Decorre do modo de \emph{performance}, justamente, o nome tardio para a mélica,
\emph{lírica}, que prevalecerá na referência moderna a tal gênero somado a outros, elegia e jambo, que compõem, juntos, um variado corpo de
textos de vários autores, metros, dialetos, tradições culturais, temas,
\emph{performances}, tons --- que nem são poesia hexamétrica, como a
épica ---, nem dramática --- tragédia e comédia. Esse uso moderno do nome é decerto
prático, mas acaba por vestir, com um mesmo manto,
gêneros poéticos autônomos e distintos que os antigos jamais unificaram ou confundiram, o elegíaco, o mélico e o jâmbico, por vezes tratados como subgêneros da lírica --- um grave equívoco de importantes consequências para seu entendimento. \emph{Mélica}, essa palavra não
dicionarizada em nosso vernáculo, é o termo que os antigos identificavam à
\emph{lírica}, rigorosamente, o gênero da canção para a lira e tão"-somente ele. }\looseness=-1
...
\emph{representada} no presente da composição. Há, portanto, uma filtragem
...
\emph{persona}, elaborada em linguagem artística diversa --- não importa
...
e do modo de \emph{performance}, bem como da linguagem, do caráter, do tom, e
...
Claro está, a esta altura, que há uma defasagem considerável, para não dizer
 ...
 \emph{performance} em viva voz --- e de seus universos, conceitos relativos à
...
ocasião, “fincada no sistema social de uma \emph{pólis} grega arcaica”,
recorda Wolfgang Rösler, é essencialmente discurso.\footnote{ Ver
Rösler (1985, p.\,139), Johnson (1982, p.\,72) e Clay \mbox{(1998, p.\,11)}.}

\textls[-15]{Em conclusão a essas palavras, cabe esclarecer que não se trata, aqui, de negar
qualquer medida de identificação entre o poeta e seu \emph{eu} poético, mas de
...
bem mostra este aviso aos que buscam a obra de Safo que, reunida com rigor,}\looseness=-1

\begin{quote}
\textls[-15]{contém apenas um poema completo, aproximadamente dez fragmentos substanciais,
uma centena de citações breves de autores antigos e cerca de 50 peças de textos
em papiro, que emergiram das areias do deserto egípcio.}\looseness=-1
\end{quote}
...
\emph{porque} sabemos que está em meros fragmentos, agimos, falamos
...
a \emph{lésbica}, restará pouco mais do que ficções e anedotas. Penso que,
...
Alexandria, isto nos conta da vida de Safo:\footnote{\emph{Papiro de Oxirrinco} 1800,
...
compleição escura. Já o léxico bizantino \emph{Suda}, compilado no século \textsc{x},
...
para dizer o mínimo, mesmo que associado a outros testemunhos.\footnote{\textls[10]{Na
...
Safo \emph{lésbica}? Vejamos um pouco do muito que se diz, e do
pouco que podemos dizer.

\textls[-10]{Embora seja a mais velha das poetas mulheres listadas no epigrama que abre esta
...
cujo \emph{corpus} é o mais extenso}\looseness=-1\footnote{Cerca de duzentos fragmentos, um dos quais é,
na verdade, uma canção completa, o “Hino a Afrodite”.} \textls[-10]{e cujos testemunhos são
...
prevalecia, ao menos na era clássica, o confinamento das mulheres ao \emph{oîkos}, “casa”, espaço
...
determinados modo e ocasião de \emph{performance} --- e dadas a celebridade e a variedade da mélica sáfica, não pode ter sido esta uma só, e nem limitada
...
não obstante inverificáveis. Da busca da Safo \emph{lésbica}, à qual
aludem os testemunhos tardios do papiro e do \emph{Suda}, o que traremos nas
mãos será um resultado semelhante, ou até mais esvaziado.

\textls[-5]{A condição de mulher poeta cujas canções têm na temática erótico"-amorosa e no
universo feminino suas linhas de força --- canções estas lidas em chave
\emph{biografizante} já pelos antigos que nelas buscavam a substância da figura
...
P. Hallett}\looseness=-1\footnote{ Hallett (1996, pp.\,125--7). Ao tratar das
imagens da poeta, ela fornece as indicações das fontes antigas.} \textls[-5]{comenta as
...
extremadas --- imagens de Safo:}\looseness=-1 
...
\begin{quote}
\emph{Condensando} numa única pessoa as muitas contradições com as quais a
...
A imagem da Safo \emph{lésbica} construiu"-se nesse movimento, e ganhou fôlego
na esteira de vogas na crítica literária --- \emph{gay studies}, \emph{women
...
\emph{lésbica} do Ocidente, não porque seja filha da ilha de Lesbos, mas
...
Digo certa leitura, porque há outros modos, mais
...
referência às mulheres de Lesbos e o uso de verbos como \emph{lesbiázein} e
\emph{lesbízein}\footnote{``Agir como uma mulher de Lesbos''.} conotavam luxúria e
...
--- as palavras \emph{Lésbia} ou \emph{moça de Lesbos} tinham a típica
conotação de \emph{fellatrix}, e não de \emph{lésbica} no sentido moderno
do termo. \emph{Lesbís} e \emph{lesbiázein} eram essencialmente peças de
...
sensualidade das mulheres da ilha, já atestada na \emph{Ilíada},\footnote{Canto \textsc{ix}, versos 128--30.}
...
\textls[-10]{A despeito dessas ressalvas, \emph{Safo de Lesbos} é designação que
recorrentemente projeta em nosso imaginário certa Safo, a poeta
\emph{lésbica}. Essa projeção, cabe entender, vale"-se do peso de Safo como referente. 
...
sexualidade que em muito se distingue da dos antigos, como ressaltado na citação de Brasete anteriormente.}\looseness=-1

Repare"-se, a propósito, que o adjetivo \emph{lésbica} não existia na
Antiguidade, tampouco o \emph{lesbianismo} em sua concepção moderna.
Volto a Brasete:
...
termo \emph{lésbica}, enfim, frisa Sue Blundell, “é uma
...
\emph{lesbianismo} --- homossexualismo feminino ---, primeiro em 1870, escrito com
...
É essa a \emph{grande questão sáfica} {[}\ldots{}{]} que já era debatida na Antiguidade, mas
...
Chamar de \emph{lésbicas} essas relações é um anacronismo. É impossível avaliar se a
...
\textls[-10]{O grau elevado de complexidade da chamada \emph{questão sáfica} é um alerta
crucial a afirmações simplistas, como as que anunciam em Safo a
primeira poeta (engajadamente) \emph{lésbica} da literatura ocidental,
...
para os anseios do dia, ajudam a manter Safo viva entre nós. Holt Parker declara:}\looseness=-1 
...
satirista Luciano, no século \textsc{ii} d.\,C.”, o \emph{Diálogo das cortesãs}.\footnote{Blundell (1995, p.\,82).} A
...
bem explorado, documentado e analisado no estudo fundamental de Kenneth J. Dover, 
...
linguagem e o tom de sua poesia por natureza tradicional, genérica e de \emph{performance}. Bem a ilustram seus fragmentos eróticos e os versos marcados pelo
erotismo em Hesíodo (ativo em \emph{c.}\,700 a.\,C.), Arquíloco (\emph{c.}\,680--640
a.\,C.), Íbico (ativo em \emph{c.}\,550 a.\,C.) e Eurípides (\emph{c.}\,482--406 a.\,C.). Eis
...
desejo nas traduções possíveis para o grego \emph{éros} que, longe de nomear
...
\begin{quote}
\begin{verse}
\textsc{\textbf{poesia didática}\quad «teogonia», de hesíodo}\\

\medskip

{[}\ldots{}{]} Eros: o mais belo entre imortais deuses,\\
deslassa-membros, de todos os deuses e de todos\qb{}os mortais\\
ele doma no peito a mente e o prudente desígnio.\footnote{Tradução minha. Edição: West (1988), versos 120--2.}\\[2mm]

\hspace*{35mm}[...]\\[2mm]

Eurínome gerou as três Cárites de belas faces --- ela,\\
a menina de Oceano, de mui amável forma:\\
Aglaia, Eufrosine e Talía amorável:\\
de seus olhos, quando fitam, goteja o desejo\\
deslassa-membros, e de sob sobrancelhas belamente\qb{}fitam.\footnote{Versos 907--11.}
\end{verse}
\end{quote}
...
\begin{quote}
\begin{verse}
\textsc{\textbf{poesia jâmbica}\quad frs.\,193 e 196 w, de arquíloco}\footnote{Tradução minha. Edição: West (1988).}\\
...
\textls[-15]{Mas o desejo deslassa-membros, ó companheiro, doma-me}\looseness=-1
\end{verse}
\end{quote}
...
\textsc{\textbf{poesia mélica}\quad fr.\,287, de íbico}\footnote{Tradução: Ragusa (2010, p.\,650; ver estudo às pp.\,480--507). Edição: Davies (1991). Cípris é um dos outros nomes de Afrodite.}\\
...
\textsc{\textbf{tragédia}\quad «hipólito», de eurípides}\footnote{Tradução: Oliveira (2010), em edição bilíngue que segue o texto grego de Barrett (1992). Os versos são a parte inicial do canto do coro de mulheres conhecido como ``Ode a Eros''.}\\
...
prudente dizer, em vista de nosso magro \emph{corpus} de textos, a partir do
...
a temática da ação da paixão sobre sua vítima e a concepção sobre \emph{éros}
...
inferir, a partir da leitura das canções em que o \emph{eu} --- nem sempre
...
\emph{lésbica}, que represente a “literatura homossexual” --- algo
demasiado modernizante e anacrônico, em se tratando dos poetas antigos
(homens ou mulheres).

O recorte de um universo que é distintamente feminino no \emph{corpus} preservado de sua poesia, inclusive
...
Ao falar de \emph{éros} numa linguagem tradicional e a partir de uma concepção
...
latino Horácio (século \textsc{i} a.\,C.), numa \emph{Epístola}:\footnote{1.\,19.\,28.}
...
mulher homossexual ou \emph{lésbica} --- é de pouca valia, inclusive para a
...
\textls[-15]{Melhor é, portanto, ir para perto da obra da poeta lésbia, como espero que esta
...
(\emph{mélos},\footnote{ Termo mais usado nos períodos arcaico e clássico.
O sentido primeiro de \emph{mélos} é “membro” do corpo, daí “membro
musical, frase” e “canção” (palavra, melodia e ritmo), na compreensão
explicitada na \emph{República} (398c), de Platão (séculos \textsc{v}--\textsc{iv} a.\,C.).
Budelmann (2009, p.\,2) lembra que \emph{mélos} é bastante usado pelos próprios poetas arcaicos ``com referência a suas composições”.} \emph{âisma, oidé}) --- daí a
designação \emph{mélica} --- e que se destinava à \emph{performance} ao som
da lira, daí \emph{lírica} em acepção específica, termo mais tardio, em
...
\emph{mélos} era, na literatura grega arcaica, o poema; o poeta,
\emph{melopoiós} --- o “fazedor de canções”, literalmente --- ou mélico; o
...
a.\,C. em diante, \emph{lírica} sobrepõe"-se a \emph{mélica} para designar a canção
...
\textls[-15]{Como se vê, o modo de \emph{performance} nomeia o gênero;
 ...
 vida cotidiana na \emph{pólis}, a eventos de um passado recente, à
 ...
 narrativa mítica e o canto de autorreferência à \emph{performance} em
 execução pelo coro. Não são mais estas palavras do que uma síntese para dar uma ideia de um cenário mais complexo.}\looseness=-1 
...
poesia \emph{de} e \emph{para} a voz”, Gustavo Guerrero
...
reconstrução clara e precisa de sua \emph{performance}, entre as quais, as
...
Recompondo minimamente o quadro, haveria para a canção solo várias audiências e
 ocasiões de \emph{performance} possíveis, com destaque para o simpósio,
...
alternativos ao interesse ecumênico do \emph{epos} e à ambientação
...
homens na \emph{pólis}.\footnote{ Schimitt"-Pantel (1990, p.\,15).} O simpósio
é, portanto, coletivo do ponto de vista do
evento, mas restrito do ponto de vista da classe e do gênero;\footnote{A presença
feminina limitava"-se às tocadoras de \emph{aulo}, instrumento de sopro, às
dançarinas --- normalmente \emph{heteras}, espécie de cortesãs ---, e às servidoras de bebida.} e era pautado por um
...
\emph{simposiástica}.\footnote{ Murray (1990, p.\,7).}

No andamento do evento, o beber era privilegiado e, por isso, tornou"-se
altamente ritualizado. A \emph{(re)performance} amadora ou profissional da
...
versos em que o \emph{eu} poético fosse de uma mulher, admitindo"-se, no contexto, a
...
\begin{quote}
\textls[-10]{{[}\ldots{}{]} a aparente privacidade da canção monódica não é do individual espontâneo,
...
invectiva, contra os de fora.}\looseness=-1\footnote{ Most (1982, p.\,90).}
\end{quote}

O simpósio é mais voltado ao “mundo do privado”, frisa Schimitt"-Pantel, menos
formal e oficial do que o festival próprio à \emph{performance}
da canção coral; nem por isso, todavia, deixa de ser público e
ritualizado.\footnote{ Schimitt"-Pantel (1990, p.\,25).} Na
“tentativa de generalização”, Most diz sobre a \emph{performance} e função da
...
A mélica nas modalidades solo e coral está representada no \emph{corpus} sobrevivente
de Safo, que conta ainda com ao menos um fragmento de narrativa de
caráter \emph{epicizante}.\footnote{Não sabemos se coral ou solo na \emph{performance}} 
Falemos um pouco mais da canção coral.

Feita para a apresentação no festival cívico"-religioso, patrocinado
pelos governos e aristocracias das \emph{póleis}, no qual se
desenvolviam muitas atividades --- como o \emph{agón} ou ``competição'' 
para cada gênero poético, para a música e para o corpo (os jogos) ---, a canção coral tinha no poeta o compositor das palavras e
...
“tônica dominante”, frisa Herington, “o \emph{prazer}, humano e
...
\emph{performance} da mélica coral os grandes funerais e as grandes bodas.
...
\emph{performers}, pelo poeta cuja voz ganha dimensão mais
...
\end{quote}
 ...
 que já lhe confere, pela natureza de seus metros, uma sonoridade bem ritmada. Em Safo, até onde permite afirmar seu \emph{corpus} preservado,
 ...
 sua audiência, sua ocasião e seu modo de \emph{performance} presumivelmente com participação da própria poeta, na Mitilene arcaica, e de seu grupo de \emph{parthénoi}, em festivais cívico"-cultuais públicos e em cerimônias de casamento, ocasiões valorizadas no estudo de Franco Ferrari.\footnote{Ferrari (2010) se baseia nas novas reflexões a que levaram os avanços nos estudos de \emph{performance} e a descoberta do novo fragmento da poeta (``Canção sobre a velhice''), em 2004, que nos fez reavaliar a coralidade em Safo e a natureza coral de sua associação de \emph{parthénoi}. Ferrari traz um olhar fresco ao aproximá"-la de Álcman, o poeta dos partênios --- canções para coros de virgens --- atuante na Esparta de c.\,620 a.\,C. Ver ainda Ragusa (2019a, pp.\,85--111; 2019b, pp.\,211--39).}
Diga"-se, nas palavras de Giulia Sissa,\footnote{Sissa (1990, p.\,76).} que a \emph{parthénos} se define “por idade e estatuto marital”, e é um “estágio pelo qual toda mulher passava na rota rumo à completa integração social” pelo \emph{gámos} (casamento). A \emph{parthénos} é, pois, aquela que chegou ao amadurecimento sexual indicado pela menarca, ao florescer da feminilidade. Como diz Mary Lefkowitz,\footnote{Lefkowitz (1995, p.\,32).} “o principal papel da mulher na sociedade antiga” era desempenhado pela \emph{gyné}, a ``mulher adulta'': o de ser esposa e mãe; daí o interesse e a atratividade da \emph{parthénos}, cuja energia vital deve convergir para o mundo do \emph{gámos} que a institucionaliza socialmente e que lhe confere, uma vez consumado, um lugar social definido na condição de \emph{gyné.} Daí o fascínio da figura da \emph{parthénos}, cujos principais cantores são decerto os mélicos Álcman, poeta ativo na Esparta de c.\,620, famoso pelas canções para coros de virgens (\emph{partênios}) e Safo.
No mundo da coralidade e como \emph{khorodidáskalos}, ``mestra do coro'', equiparada à líder das Musas,\footnote{Bela Voz ou Calíope.} vislumbra"-a um epigrama anônimo que a insere no famoso templo lésbio de Hera, em que, segundo Alceu,\footnote{Fr.\,130\textsc{b}, traduzido em Ragusa, 2013.} contemporâneo da poeta em Lesbos, havia concursos anuais de beleza em homenagem à deusa:

\begin{quote}
\begin{verse}
Vinde ao sacro recinto esplêndido de Hera de olhos de\qb{}touro,\\
\hspace*{4.5em} ó lesbias, os delicados passos dos pés\qb{}rodopiando;\\
lá, belo coro à deusa firmai; a vós liderará\\
\hspace*{4.5em} Safo, nas mãos tendo a áurea lira.\\
Felizes --- vós! --- no regozijo da dança; sim!,\qb{}doce hino\\
\hspace*{4.5em} \textls[-15]{pensareis ouvir, da própria Calíope!}\looseness=-1\footnote{\emph{\textsc{ap}} \textsc{ix}, 189.}
\end{verse}
\end{quote}
...
\emph{performance}. Note"-se, enfim, que boa parte da música entoada pelas
personagens épicas da \emph{Ilíada} e da \emph{Odisseia} ilustra as formas
...
da boda. Segundo Cecil M. Bowra, com variações
...
encontramos uma poesia menos “pessoal”, que mais ``pública'' se afigura e, por isso mesmo, bem menos propícia à tão frequente leitura romântico"-biografista do \emph{corpus} de
...
pela qual se faz a autodramatização da poeta como \emph{persona}, a força da primeira pessoa do singular, o caráter
aparentemente intimista, as numerosas figuras
femininas contempladas em chave erótica ---, tudo isso estimula aquela referida.
Mas tais elementos, incluindo o homoerotismo, mais coerentemente devem ser pensados, como se tem argumentado após a descoberta da ``Canção sobre a velhice'', no âmbito da coralidade e das associações corais femininas, atestadas com evidências consistentes pelo mundo arcaico afora.\footnote{Ver estudos indicados à nota 75 e ainda Lardinois (1994, pp.\,57--84; 1996, pp.\,150--72). Todos tratam da relação das meninas e de sua líder, Safo, a partir da ideia da coralidade e das associações corais em que se dava a \emph{paideía} feminina, atestadas no mundo arcaico. Tal formação, sentido do termo grego, era conduzida por uma mulher adulta, e tinha no casamento uma de suas orientações, bem como na formação ético"-moral e nas atividades femininas, no cantar e no dançar, nos ritos e em outros âmbitos.} 

Nelas, as \emph{parthénoi}, as moças não casadas, recebiam a formação --- \emph{paideía} --- feminina específica, que incluía a \emph{khroreía} ou ``atividade coral'' --- canto, dança, música ---, a reafirmação de valores ético"-morais e o conhecimento da tradição mítica --- elementos de força nas composições da mélica coral em geral ---, a preparação para o \emph{gámos} no exercício da sensualidade, do erotismo, internamente ao universo feminino. A formação do grupo de meninas, sublinha Christina Clark,\footnote{Clark (1996, p.\,144).} era parte integral de um “processo que inculcava responsabilidade cívica, valores sociais e tradições {[}\ldots{}{]} codificados na \emph{performance} que servia para integrar o indivíduo do sexo feminino em seu contexto social”.


\textls[-15]{No que tange ao biografismo e à simplista equiparação poeta"-\emph{persona} aos quais tão bem se prestam as canções da mélica sáfica forjadas, pela habilidade retórica, para serem percebidas como intimistas, pessoais e privadas, há que reafirmar: se a identificação é problemática,
a separação radical também o é; na verdade, há que reconhecer certa medida de
proximidade e outra de distância entre o \emph{eu} do poeta e o de seus versos. Qual
...
transmitida pela especulação e pela simplificação.}\looseness=-1
...
\emph{persona} chegou tarde e com grande dificuldade”, prossegue ele (p.\,16),
...
Oliva, 1996): ``\emph{Meu pau no cu, na boca, eu vou meter"-vos,/ Aurélio bicha
...
aqui? Catulo ou seu \emph{eu} poético? Quão identificados estão um e outro? E quanto
...
\emph{performance} perante uma audiência, em dada situação e de certo modo
...
irresponsável. O Eu é o Eu do \emph{performer}, que se move através de um
\emph{continuum} no qual o Eu biográfico e o Eu ficcional são os dois
extremos: na maior parte do tempo, ele não é nenhum deles.\footnote{ Slings (1990, pp.\,11--12).}
\end{quote}


\section*{safo, sua mélica e o coro de virgens}

Resumo o cenário para Safo e sua mélica. Esta, como toda a poesia grega, tem por principais ocasiões de \emph{performance} os festivais cívico"-cultuais públicos e o simpósio. Este, para as canções de Safo, destina"-se à \emph{reperformance}, e não à apresentação original da poeta, porque é, como se disse, eminentemente masculino. Isso significa, porém, que, na dramaticidade inerente à “cultura da canção”, o cantor de sua poesia no simpósio assumia o papel do \emph{eu} feminino, quando feminina fosse a voz da canção. Mais seguras como ocasiões de \emph{performance} da mélica sáfica são o festival público cívico"-cultual e a festividade de casamento. Ferrari sublinha nos fragmentos da poeta as indicações nesse sentido: 
...
As canções de Safo são dirigidas a seu grupo feminino de \emph{parthénoi}, as moças ou meninas. Isso que foi reforçado pela “Canção sobre a velhice”, como o foi a coralidade, já se via nos seus fragmentos, na frequência impressionante de termos como \emph{kórai}, \emph{parthénoi}, \emph{paîdes}, que, para além de nomes de figuras femininas, fazem das meninas, “com toda probabilidade, o assunto da maior parte da poesia de Safo”, sublinhava Lardinois.\footnote{Lardinois (1994, p.\,70).} A propósito dessa coralidade feminina, Lardinois afirma:

\begin{quote}
Dado o fato de que as mulheres gregas antigas, e tanto mais as jovens, não eram encorajadas a falar em público, é notável que tantas \emph{performances} de coros de moças jovens sejam atestadas, especialmente no período arcaico.
\end{quote}

Atestadas, sim; sobreviventes, bem poucas. Mas canções como as de Álcman --- os \emph{partênios} --- ``adotam uma perspectiva distintivamente feminina, ambos nos mitos que contam e nas visões que expressam sobre outras mulheres'', prossegue, esclarecendo que usa o termo feminino como designação para ``um conceito ou comportamento que uma dada cultura tipicamente associa às mulheres {[}\ldots{}{]}''.\footnote{Lardinois (2011, p.\,161).}
...
No epigrama da \emph{Antologia palatina} --- compilação de 15 livros de
...
\textls[-15]{Mirtes (Beócia, fins do século \textsc{vi} a.\,C.), da qual nada resta, teria sido mestra
...
é bastante nebulosa, como a própria imagem de Mirtes:}\looseness=-1
...
\textls[-10]{Praxila, ativa em meados do século \textsc{v} a.\,C., assim surge num passo do gramático
Ateneu (séculos \textsc{ii}--\textsc{iii} d.\,C.), no \emph{Banquete dos eruditos}:}\looseness=-1\footnote{15, 694\textsc{a}.}
\textls[-10]{``Praxila de Sícion era também admirada pela composição de cantos
convivais” para acompanhar o beber do vinho, nos simpósios. De sua obra,
porém, temos apenas o fragmento de um “Hino a Adônis”,}\looseness=-1\footnote{747 Page.} \textls[-10]{outro
de um “Ditirambo: Aquiles”,}\looseness=-1\footnote{748 Page.} \textls[-10]{e três de canções convivais. No fragmento
hínico, o mítico jovem amante de Afrodite, Adônis, arrola as mais belas coisas
que deixou no mundo dos vivos ao morrer, no auge de sua juventude e virilidade:}\looseness=-1
...
Agamêmnon, ao arrebatar"-lhe Briseida, seu \emph{géras}, “prêmio” --- parte do
...
supostamente biográfico: segundo Plutarco\footnote{Em \emph{As
virtudes das mulheres}, 4. 245c"-\textsc{f}.} (séculos \textsc{i}--\textsc{ii} d.\,C.) e Pausânias\footnote{Em 
\emph{Descrição da Grécia}, 2. 20. 8--10.} (século \textsc{ii} d.\,C.), ela teria liderado um conflito
militar contra Cleomenes, de Esparta, o que jogaria sua datação para \emph{c.}\,494 a.\,C. Pausânias descreve, no santuário de Afrodite em Argos, diante da
...
confiarmos em Máximo de Tiro\footnote{Em \emph{Oração} 37. 5.} (século \textsc{ii} d.\,C.), segundo
...
\textls[-10]{A imagem da poeta pode ter se nutrido dos
...
remanescente de Telesila: cinco fragmentos, o maior, com dois versos,}\looseness=-1\footnote{Fr.\,717 Page.} \textls[-10]{ao que se vislumbra, sobre o mito da paixão do deus"-rio Alfeu pela irmã de Apolo,
...
\begin{quote}
\begin{verse}
{[}\ldots{}{]} sobre mim Terpsícore {[}\ldots{}{]}\\
...
formam a maioria dos pequenos e corrompidos textos do \emph{corpus} de
Corina, como o Fr.\,664\textsc{b}. Nele, a \emph{persona} da poeta declara um
tema de sua mélica:

\begin{quote}
\begin{verse}
{[}\ldots{}{]} canto as excelências dos heróis\\
...
verdade, uma sala entre outras do \emph{Mouseîon} (“a casa das Musas”,
...
helenista; e “a palavra grega \emph{epigramma} significa ‘inscrição’\,”. Os
epigramas das poetas de que passo a me ocupar encontram"-se na \emph{Antologia
palatina}.

%Dúvida: esse "11, 491b diz respeito ao que?"
Mero, de Bizâncio, é a mais desconhecida; dela só há dois epigramas na \emph{\textsc{ap}}:\footnote{Livro \textsc{vi}, 119 e 189.} uma dedicatória às uvas viníferas,
...
\textls[-5]{Outra poeta, Erina --- não sabemos ao certo sua origem ---, também praticou o
epigrama e a poesia épica. Magro, porém, é seu \emph{corpus}: três epigramas, um fragmento com dois versos hexamétricos, pedaços
de “O fuso do tear”, longo poema}\looseness=-1\footnote{São cerca de 300 versos.} \textls[-5]{em hexâmetros e dialetos
lésbio"-eólico e dórico, preservado num papiro muito mutilado que revela somente
algumas palavras. Um epigrama anônimo}\looseness=-1\footnote{\emph{\textsc{ap}}, \textsc{ix}, 190.}
\textls[-5]{sobre Erina a dá por lésbia, conta sua morte ainda virgem aos 19 anos, e
afirma que os versos de “O fuso” são \emph{iguais} aos de Homero. Por fim,
declara que ``tanto quanto Safo supera Erina em canções, Erina supera
Safo em hexâmetros''.}\looseness=-1\footnote{Versos 7--8.}

Sobre os epigramas atribuídos a Erina, Snyder observa
serem todos concernentes às mulheres: o 352\footnote{\emph{\textsc{ap}}, \textsc{vi}.}
retrata uma mulher de nome Agatárquis; o 710 e o 712,\footnote{\emph{\textsc{ap}}, \textsc{vii}} a morte de 
...
em meu sepulcro estas palavras inscreveu.\footnote{Tradução Ramos (1964, p.\,161). Noto que as \emph{sereias} são na verdade \emph{sirenas}, mulheres"-aves, no imaginário mítico grego.}
\end{verse}
\end{quote}

Já Anite tem 24 
epigramas, informa Snyder.\footnote{ Snyder (1989, p.\,67).} Segundo o \emph{Onomástico}\footnote{5. 48.} de
...
levou-lhe embora os dois bichinhos de estimação.\footnote{\emph{\textsc{ap}} \textsc{vii}, 190.}\\!

\medskip

Vivo, este homem era Manes, um escravo; morto,\\*
vale agora o mesmo que o grande Dario.\footnote{Paes (1995, pp.\,34--5). Dario foi imperador persa entre c. 522--586 a.\,C.}\footnote{\emph{\textsc{ap}} \textsc{vii}, 538.}\\*
\end{verse}
\end{quote} 
...
313:\footnote{\emph{\textsc{ap}} \textsc{ix}.}
...
\textls[-20]{Merecem nota, ainda, os curiosos epitáfios para animais --- dos quais o epigrama
190,}\looseness=-1\footnote{\emph{\textsc{ap}} \textsc{vii}.} \textls[-20]{já citado, é exemplo ---, o que pode ser visto como uma
brincadeira de Anite com a expectativa de quem ouve um epigrama e espera
“grande solenidade”, observa Snyder.}\looseness=-1\footnote{ Snyder (1989, p.\,70).} 

Nossa última poeta, Nóssis, nasceu em Lócris, “colônia grega no sul da Itália”,
ressalta Snyder,\footnote{Snyder (1989, p.\,77).} fundada no século \textsc{vii} a.\,C. Seu \emph{corpus} se
...
se autonomeia, anota a helenista, ``criando a vívida \emph{persona} de uma
...
\textls[-15]{Eis o que diz Nóssis; aquela a quem a Cípria}\looseness=-1\footnote{ Outro nome de Afrodite, a deusa do amor erótico, da beleza, da sedução.} \textls[-15]{não beijou,}\looseness=-1\\*
essa não sabe sequer que flores são as rosas.\footnote{\emph{\textsc{ap}} \textsc{v}, 170.}\\!
...
alguém que lhe é igual, de nome Nóssis. Vai!\footnote{\emph{\textsc{ap}} \textsc{vii}, 718. Paes (1995, pp.\,36--7).}
\end{verse}
\end{quote}
...
\emph{corpus} de sua poesia mélica e a sua reputação na Antiguidade permitem
afirmar, gira em torno de \emph{éros} (paixão, amor, desejo erótico), Nóssis
declara, indiretamente, que sua poesia se afina à mesma temática: Mitilene
gerou uma poeta de \emph{éros}; Lócris, outra que lhe é ``igual”.

Muitos nomes, mas, no geral, escassa substância:\footnote{\textls[-15]{Alguns nomes mais nebulosos ainda são
...
e Carixena, a quem o \emph{Léxico} de Fócio (patriarca de Constantinopla,
...
mas alguns a dizem também poeta lírica”. Um provérbio no \emph{Léxico} de
...
provavelmente do século \textsc{v} a.\,C.}\looseness=-1} é o que se pode espremer do acúmulo dos
...
que fincastes o início e o fim de toda a lírica.\footnotemark{} \\ 
...
Biblioteca de Alexandria. Aliás, ao tratar do termo \emph{lírica}, disse"-o
...
(\emph{c.}\,258--180 a.\,C.) seu principal executor. Segundo Pfeiffer, desse
...
elegíaca e mélica, foi viabilizada, como vimos, por \emph{performances} e
\emph{reperformances} --- nos mesmos moldes ou não, profissionais ou amadoras ---, pela
...
restritas e, certamente, custosa.\footnote{ \textls[-20]{Ver Havelock (1996, p.\,26). Tais
...
O “livro” é, na verdade, um \emph{bíblos} ou \emph{biblíon}, isto é, rolo
de papiro, sendo tardio o formato do \emph{codex}, do século \textsc{ii} d.\,C. Sobre
os copistas, muitos devem ter sido escravos, e não necessariamente saberiam ler
o que copiavam.}\looseness=-1} Tudo isso contribui para a sobrevivência dos textos até os
...
\textls[-10]{Desde a década final do século \textsc{xix} a meados do século \textsc{xx}, sobretudo,
...
gramáticos alexandrinos”.}\looseness=-1\footnote{ Nicosia (1976, p.\,32).}

\textls[-13]{Com os acréscimos, que hoje ocorrem em ritmo bem mais lento,
...
condição do \emph{corpus} da poesia jâmbica, elegíaca e mélica, em termos
...
papiros não fizeram muito por nós”.}\looseness=-1\footnote{ Kenyon (1919, p.\,9).} \textls[-13]{Animado com os acontecimentos então
...
Quase 50 anos depois, William H. Willis oferecia ao
...
\emph{aticização} dos dialetos nos quais os poemas foram compostos --- no caso de Safo,
...
\begin{bibliohedra}
\tit{battistini}, Y. (introd., trad., notas). \emph{Poétesses grecques:
Sapphô, Corinne, Anytè\ldots{}}. Paris: Imprimerie Nationale Éditions, 1998.

\tit{bennett}, C. “Concerning ‘Sappho schoolmistress’\,”. \emph{TAPhA} 124,
1994, pp.\,345--7.

\tit{blundell}, S. \emph{Women in ancient Greece.} London: British Museum
Press, 1995.

\tit{bowie}, A. M. \emph{The poetic dialect of Sappho and Alcaeus.} Salem:
Ayer, 1984. 

\tit{bowie}, E. L. “Early Greek elegy, \emph{symposium} and public festival”.
\emph{JHS} 106, 1986, pp.\,13--35.

\tit{bowra}, C. M. \emph{Greek lyric poetry.} 2ª
ed. Oxford: Clarendon Press, 1961.

\tit{bremmer}, J. N. “Pederastia grega e homossexualismo moderno”. In:
\line(1,0){25}. (org.). \emph{De Safo a Sade: momentos na história da
sexualidade.} Campinas: Papirus, 1995, pp.\,11--26.

\tit{budelmann}, F. “Introducing Greek lyric”. In:
\line(1,0){25}. (ed.). \emph{The Cambridge
Companion to Greek lyric.} Cambridge: Cambridge University Press, 2009, pp.\,1--18.

\tit{burnett}, A. P. \emph{Three archaic poets: Archilochus, Alcaeus,
Sappho.} Cambridge: Harvard University Press, 1983. 

\tit{campbell}, D. A. (ed. e trad.). \emph{Greek lyric \textsc{i}.} Cambridge:
Harvard University Press, 1994. {[}1ª ed.: 1982{]}.

\titidem. (ed. e trad.). \emph{Greek lyric \textsc{iv}.} Cambridge: Harvard
University Press, 1992.

\titidem. (coment.). \emph{Greek lyric poetry.} London: Bristol
Classical Press, 1998. {[}1ª ed.: 1967{]}. 

\tit{carey}, C. “Genre, occasion and performance”. In:
\textsc{budelmann}, F. (ed.). \emph{The Cambridge Companion to Greek
lyric.} Cambridge: Cambridge University Press, 2009, pp.\,21--38.

\tit{carson}, A. \emph{Eros, the bittersweet: an essay.} Chicago:
Dalkey Archive Press, 1998.

\tit{clay}, D. “The theory of the literary \emph{persona} in Antiquity”.
\emph{MD} 40, 1998, pp.\,9--40.

\tit{cole}, S. G. “Could Greek women read and write?”. In: \textsc{foley}, H.
P. (ed.). \emph{Reflections of women in antiquity.} Philadelphia: Gordon and
Breach, 1992, pp.\,219--45.

\tit{corrêa}, P. da C. \emph{Armas e varões: a guerra na
...
\emph{deixis} in Greek archaic lyric”. \emph{Arethusa} 37, 2004, pp.\,267--94.

\tit{davies}, M. (ed.). \emph{Poetarum melicorum Graecorum fragmenta \textsc{i}.}
Oxford: Clarendon Press, 1991.

\tit{de martino}, F. “Appunti sulla scrittura al femminile nel mondo antico''.
In: \line(1,0){25}. (ed.). \emph{Rose} \emph{de Pieria.} Bari: Levante Editori,
1991, pp.\,17--75.

\tit{dover}, K. J.  \emph{A homossexualidade na Grécia antiga.}
Trad. L. S. Krausz. São Paulo: Nova Alexandria, 1994. {[}1ª ed. orig.: 1978{]}.

\tit{easterling}, P. E.; \textsc{knox}, B.W. (ed.). \emph{The Cambridge History of
classical literature -- \textsc{i}: Greek literature.} Cambridge: Cambridge University
Press, 1990.

\tit{ferrari}, F. \emph{Sappho’s gift: the poet and her community.} Trad.
B. Acosta"-Hughes e L. Prauscello. Ann Arbor: Michigan University Press, 2010.

\tit{foley}, H. P. (ed.). \emph{Reflections of women in antiquity.}
Philadelphia: Gordon and Breach, 1992.

\tit{fränkel}, H. \emph{Early Greek poetry and philosophy.} Trad. M. Hadas
e J. Willis. Oxford: Basil Blackwell, 1975. {[}1ª ed. orig.: 1951{]}. 

\tit{gentili}, B. \emph{Poetry and its public in ancient Greece.} Trad. A.
T. Cole. Baltimore: The Johns Hopkins University Press, 1990a.
{[}1ª ed. orig.: 1985{]}

\titidem. “Lo ‘io’ nella poesia lirica greca”. \emph{AION (filol)} 12,
1990b, pp.\,9--24.

\tit{guerrero}, G. \emph{Teorías de la lírica.} México: Fondo de
Cultura Económica, 1998.

\tit{johnson}, W. R. \emph{The idea of lyric. Lyric modes in ancient and
modern poetry.} Berkeley: University of California Press, 1982.

\tit{hallett}, J. P. “Sappho and her social context”. In: \textsc{greene}, E.
(ed.). \emph{Reading Sappho: contemporary approaches.} Berkeley: University
of California Press, 1996, pp.\,125--42.

\tit{harvey}, A. E. “The classification of Greek lyric poetry”. \emph{CQ}
5, 1955, pp.\,157--75.

\tit{havelock}, \textls[-20]{E. \emph{A revolução da escrita na Grécia e suas
consequências culturais.} Trad. O. J. Serra. São Paulo, Rio de Janeiro: Editora
da Unesp, Paz e Terra, 1996.}\looseness=-1

\tit{henderson}, W. J. ``Received responses: ancient testimony on Greek lyric imagery.'' 
\emph{AClass} 41, 1998, pp.\,5--27. 

\tit{herington}, J. \emph{Poetry into drama. Early tragedy and the Greek
poetic tradition.} Berkeley: University of California Press, 1985.

\tit{kenyon}, F. G. “Greek papyri and classical literature”.
\emph{JHS} 39, 1919, pp.\,1--15.

\tit{lardinois}, A. “Safo lésbica e Safo de Lesbos”. In: \textsc{bremmer}, J.
(org.). \emph{De Safo a Sade: momentos na história da sexualidade.} Campinas:
Papirus, 1995, pp.\,27--50.

\tit{lesky}, A. \emph{História da literatura grega.} Trad. M. Losa. Lisboa:
Fundação Calouste Gulbenkian, 1995. {[}1ª ed. orig.: 1957{]}.

\tit{lourenço}, F. (trad.). \emph{Poesia grega de Álcman a Teócrito.}
Lisboa: Livros Cotovia, 2006.

\tit{mossé}, C. \emph{La femme dans la Grèce antique.} Paris: Éditions
Complexe, 1991.

\tit{most}, G. W. “Greek lyric poets”. In: \textsc{luce}, T. J. (ed.). \emph{Ancient writers -- \textsc{i}: Greece and Rome}. New York: Charles Scribner's Sons, 1982, pp.\,75--98. 

\titidem. ``Reflecting Sappho.'' In: \textsc{greene}, E (ed.) 
\emph{Re"-reading Sappho: reception and transmission}. Berkeley: University of California Press,
1996, pp.\,11--35.

\tit{murray}, O. “Sympotic history”. In: \line(1,0){25}. (ed.).
\emph{Sympotica. A symposium on the symposion.} Oxford: Clarendon Press,
1990, pp.\,3--13.

\titidem. \emph{Early Greece.} 2ª ed.
Cambridge: Harvard University Press, 1993.

\tit{nicosia}, S. \emph{Tradizione testuale diretta e indiretta dei poeti
di Lesbo.} Roma: Ateneo, 1976. 

\tit{oliva neto}, J. A. (trad., introd. e notas). \emph{Catulo. O Livro de
Catulo.} São Paulo: Edusp, 1996.

\tit{oliveira}, F. R. (introd., trad. e notas). \emph{Hipólito. Eurípides.}
São Paulo: Odysseus, 2010.

\tit{paes}, J. P. (trad., notas, posfácio). \emph{Poemas da Antologia grega
ou palatina, séculos \textsc{vii} a.\,C. a \textsc{v} d.\,C.} São Paulo: Companhia das Letras, 1995.

\tit{page}, D. L. (ed.). \emph{Poetae melici Graeci.} Oxford: Clarendon
Press, 1962.

\titidem. \emph{Sappho and Alcaeus.} Oxford: Clarendon
Press, 2001. {[}1ª ed.: 1955{]}.

\tit{parker}, H. “Sappho schoolmistress”. In: \textsc{greene}, E. (ed.).
\emph{Re"-reading Sappho: reception and transmission.} Berkeley: University of
California Press, 1996, pp.\,146--83.

\tit{pfeiffer}, R. \emph{A history of classical scholarship -- \textsc{i}.} Oxford:
Clarendon Press, 1998. {[}1ª ed.: 1968{]}

\tit{ragusa}, G. \emph{Fragmentos de uma deusa: a representação de Afrodite
na lírica de Safo}. Campinas: Editora da Unicamp, 2005. (Apoio: Fapesp).

\titidem. \emph{Lira, mito e erotismo: Afrodite na poesia mélica grega
arcaica}. Campinas: Editora da Unicamp, 2010. (Apoio: Fapesp).

\tit{robb}, K. \emph{Literacy and paideia in ancient Greece.} New York,
Oxford: Oxford University Press, 1994.

\tit{rösler}, W. “Persona reale o persona poetica?”. \emph{QUCC} 19, 1985,
pp.\,131--44.
...
(ed.). \emph{The Cambridge Companion to archaic Greece.} Cambridge: Cambridge
University Press, 2007, pp.\,1--9.

\tit{skinner}, M. B. “Woman and language in archaic Greece, or, Why is Sappho
a woman?”. In: \textsc{greene}, E. (ed.). \emph{Reading Sappho: contemporary
approaches.} Berkeley: University of California Press, 1996, pp.\,175--92.

\tit{slings}, S. R. “The \emph{I} in personal archaic lyric: an
introduction”. In: \line(1,0){25}. (ed.). \emph{The poet’s I in archaic Greek
lyric.} Amsterdam: VU University Press, 1990, pp.\,1--30.

\tit{snell}, B (ed.). \emph{A cultura grega e as origens do pensamento
europeu.} Trad. P. de Carvalho. São Paulo: Perspectiva, 2001. {[}1ª ed. orig.:
1955{]}.

\tit{snyder}, J. M. \emph{The woman and the lyre: women writers in
...
\tit{svenbro}, J. \emph{Phrasiklea. An anthropology of reading in ancient
Greece.} Trad. J. Lloyd. Ithaca: Cornell University Press, 1993.

\tit{vetta}, M. “Poesia simposiale nella Grecia arcaica e classica”. In:
\line(1,0){25}. (ed.). \emph{Poesia e simposio nella Grecia arcaica.}
Bari: Laterza, 1995, pp.\,xi--lx.

\tit{west}, M. L. “Greek poetry 2000--700 \textsc{b.c.”.} \emph{CQ} 23, 1973,
pp.\,179--92.

\titidem. (ed.). \emph{Iambi et elegi Graeci.} Oxford: Oxford University
Press, 1998. vols. 1--2. {[}1ª ed.: 1971{]}.

\tit{willis}, W. H. “A census of the literary papyri from Egypt”.
\emph{GRBS} 9, 1968, pp.\,205--41.


\section*{adendo bibliográfico à 2ª edição}

\tit{Bartol}, K. “Saffo e Dika (Sapph. 81 V.)”. \emph{QUCC} 56, 1997, pp.\,75--80.

\tit{Bierl}, A. “Alcman at the end of Aristophanes' \emph{Lysistrata}”. In: \textsc{athanassaki}, L.; \textsc{bowie}, E. (eds.). \emph{Archaic and classical song}. Berlin: De Gruyter, 2011, pp.\,415--436.

\titidem.  “\emph{Symmachos esso}: theatrical role"-playing and mimesis in Sappho fr.\,1\textsc{v}.”. in: \textsc{biggliazzi}, S. (eds.). \emph{Συναγωνίζεσται. Essays in honour of Guido Avezzù}. Verona: Skène, 2018, pp.\,925--951.


\tit{bowman}, L. “The ‘women’s tradition’ in Greek poetry”. \emph{Phoenix} 58, 2004, pp.\,1--27.

\tit{brasete}, M. F. “O amor na poesia de Safo”. In: \textsc{ferreira}, A. M. (ed.). \emph{Percursos de Eros -- representação do erotismo}. Aveiro: Universidade de Aveiro, 2003, pp.\,17--26.

\titidem. “Homoerotismo feminino na lírica grega arcaica: a poesia de Safo”. In: \textsc{fialho}, M. do Céu et alii (eds.). \emph{A sexualidade no mundo antigo}. Lisboa, Coimbra: Centro de História da Universidade de Lisboa/Centro de Estudos Clássicos e Humanísticos U. Coimbra, 2009, pp.\,289--303. 

\tit{bruss}, J. S. “Epigram”. In: \textsc{clauss}, J. J.; \textsc{cuypers}, M. (eds.). \emph{A companion to Hellenistic literature}. Malden: Wiley"-Blackwell, 2010, pp.\,117--35. 

\tit{buzzi}, S. et alii (eds.). \emph{Nuove acquisizioni di Saffo e della lirica greca}. Alessandria: Edizioni dell'Orso, 2008.

\tit{Caciagli}, S. “Sapph. fr.\,27\textsc{v}.: l’unità del pubblico saffico”. \emph{QUCC} 91, 2009, pp.\,63--80.

\tit{cazzato}, V.; \textsc{lardinois}, A. (eds.) \emph{The look of lyric: Greek song and the visual. Studies in archaic and classical Greek song, vol.\,1}. Leiden: Brill, 2016.

\tit{Clark}, C. A. “The gendering of the body in Alcman’s \emph{Partheneion} 1: narrative, sex and social order in archaic Sparta”. \emph{Helios} 23, 1996, pp.\,143--172.

\tit{ferrari}, F. “Il pubblico di Saffo”. \emph{SIFC} 1, 2003, pp.\,42--89.

\titidem. (trad., notas, introd.). \emph{Saffo. Poesie}. Milano: \textsc{bur} Rizzoli, 2011.

\tit{greene}, E.; \textsc{skinner}, M. B. (eds.). \emph{The new Sappho on old age. Textual and philosophical issues}. Washington, \textsc{d.c.}: Center for Hellenic Studies, 2009.

\tit{Hague}, R. H. “Ancient Greek wedding songs: the tradition of praise”. \emph{Journal of Folklore Research} 20, 1983, pp.\,131--43.

\tit{klinck}, A. \emph{Woman’s song in ancient Greece}. Montreal: McGill-Queen’s University Press, 2008. 

\tit{lardinois}, A. “Subject and circumstance in Sappho’s poetry”. \emph{TAPhA} 124, 1994, pp.\,57--84.

\titidem. “Who sang Sappho’s songs?”. In: \textsc{greene}, E. (ed.). \emph{Reading Sappho}. Berkeley: University of California Press, 1996, pp.\,150--72.

\titidem. ``Lesbian Sappho revisited''. In: \textsc{dijkstra}, J. et alii (eds.). \emph{Myths, Martyrs, and Modernity. Studies in the History of Religions in Honour of Jan N. Bremmer}. Leiden: Brill, 2010, pp.\,13--30.

\titidem. “The \emph{parrhesia} of young female choruses in ancient Greece”. In: \textsc{athanassaki}, L.; \textsc{bowie}, E. (eds.). \emph{Archaic and classical song: performance, politics and dissemination}. Berlin: De Gruyter, 2011, pp.\,161--72. 

\tit{Lefkowitz}, M. R. “The last hours of the \emph{parthenos}”. In: \textsc{reeder}, E. D. (ed.). \emph{Pandora’s box. Women in classical Greece}. Baltimore, Princeton: The Walters Art Gallery / University Press, 1995, pp.\,32--39. 

\tit{Paton}, W, R. \emph{The Greek anthology -- \textsc{iii}: book \textsc{ix}}. London, Cambridge: William Heinemann, Harvard University Press, 1916--18. 5 vols.

\tit{ragusa}, G. “Memória, a terra prometida dos poetas: o tema na mélica grega arcaica”. \emph{Forma Breve} 15, 2018, pp.\,143--52. 

\titidem. “A coralidade e o mundo das \emph{parthénoi} na poesia mélica de Safo”. \emph{Revista Aletria} 29.4, 2019a, pp.\,85--111. 

\titidem. “Safo de Lesbos: de liras e neblinas”. In: \textsc{rede}, M. (org.). \emph{Vidas Antigas. Ensaios Biográficos da Antiguidade}. São Paulo: Editora Intermeios, 2019b, pp.\,211--39.

\titidem; \textsc{rosenmeyer}, P. “A delicate bridegroom: \emph{habrosunē} in Sappho, Fr.\,115\textsc{v}”. \emph{CQ} 69, 2019, pp.\,62--75.

\titidem. ``Nove Musas mortais: as poetas da Grécia antiga''. \emph{Revista do Centro de Pesquisa e Formação} (\textsc{sesc}) 11, 2020, pp.\,113--136.

\titidem. (org., trad.). \emph{Lira grega: antologia de poesia arcaica}. 2ª\,ed.\, São Paulo: Hedra, 2024.

\tit{Ramos}, P. E. da S. (trad. e notas). \emph{Poesia grega e latina}. São Paulo: Cultrix, 1964.

\tit{Redfield}, J. M. “Notes on the Greek wedding”. \emph{Arethusa} 15, 1982, pp.\,181--201. 

\titidem; \textsc{delfito}, J. S. S. “Corina: uma voz feminina da poesia grega antiga e suas canções”. \emph{Translatio},  18, 2020, pp.\,3--16.

\tit{reeder}, E. D. (ed.). \emph{Pandora’s box. Women in classical Greece}. Baltimore, Princeton: The Walters Art Gallery/University Press, 1995.


\tit{Scodel}, R. “Self-correction, spontaneity, and orality in archaic poetry”. In: \textsc{worthington}, \textsc{i}. (ed.). \emph{Voice into text. Orality and literacy in ancient Greece}. Leiden: Brill, 1996, pp.\,59--79.

\tit{Sissa}, G. \emph{Greek virginity}. Trad. A. Goldhammer. Cambridge: Harvard University Press, 1990.

\tit{Stehle}, E. \emph{Performance and gender in ancient Greece: nondramatic poetry and its setting}. Princeton: University Press, 1997.

\tit{Swift}, L. A. \emph{The hidden chorus. Echoes of genre in tragic lyric}. Oxford: Oxford University Press, 2010.

\enlargethispage{2\baselineskip}
\tit{Thomas}, B. M. “The rhetoric of prayer in Sappho's `Hymn to Aphrodite'”. \emph{Helios} 26, 1999, pp.\,3--10.

\tit{West}, M. L. (ed. e coment.). \emph{Hesiod, Theogony}. Oxford: Clarendon Press, 1988.
