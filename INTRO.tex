...
\begin{verse}
\begin{quote}
\parindent=0em\textsc{«teogonia», hesíodo}
...
\begin{verse}
\begin{quote}
\parindent=0em\textsc{fragmentos 193 e 196 w, arquíloco}\footnote{Tradução minha. Edição: West (1988).}
...
\parindent=0em\textsc{fragmento 287, íbico}\footnote{Tradução: Ragusa (2010, p.\,650; ver estudo às pp.\,480--507). Edição: Davies (1991). Cípris é um dos outros nomes de Afrodite.}
\textit{(Poesia mélica)}
\medskip
...
\begin{verse}
\begin{quote}
\parindent=0em\textsc{«hipólito», eurípides}\footnote{Tradução: Oliveira (2010), em edição bilíngue que segue o texto grego de Barrett (1992). Os versos são a parte inicial do canto do coro de mulheres conhecido como ``Ode a Eros''.}
\textit{(Tragédia)}
\medskip
...
\begin{verse}
\begin{quote}
\parindent=0em Vinde ao sacro recinto esplêndido de Hera de olhos de touro,\\
...
\begin{verse}
\begin{quote}
\parindent=0em \ldots{} eu censuro a clarissonante\\
...
\begin{verse}
\begin{quote}
\parindent=0em \ldots{} o que de mais belo eu deixo: a luz do sol,\\
...
\end{quote}
\vspace{-.3\baselineskip} % Reduz o espaçamento extra antes do próximo parágrafo
\end{verse}
...
\begin{verse}
\begin{quote}
\parindent=0em {[}\ldots{}{]} sobre mim Terpsícore {[}\ldots{}{]}\\
...
\begin{verse}
\begin{quote}
\parindent=0em{[}\ldots{}{]} canto as excelências dos heróis\\
...
\begin{verse}
\begin{quote}
\parindent=0em Jazes sob o áureo pórtico de Afrodite,\\
...
\begin{verse}
\begin{quote}
\parindent=0em Ó estrelas e Sereias, urna funerária\\ 
...
\begin{verse}
\begin{quote}
\parindent=0em Para o seu gafanhoto, rouxinol dos campos, e a sua\\
...
\begin{verse}
\begin{quote}
\parindent=0em Senta-te de todo sob as belas folhas vicejantes do loureiro\\
...
\begin{verse}
\begin{quote}
\parindent=0em Nada mais doce que o amor; tudo quanto haja de ditoso\\
