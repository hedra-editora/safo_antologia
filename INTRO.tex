\chapter*{Introdução \subtitulo{Safo revisitada e a viagem pela\break poesia grega
antiga}}
...
% \MakeUppercase{R}agusa (2005, pp.~23--53, 55--78; 2010, pp.~23--53, 55--97).}}
% Dúvida: Ao que diz respeito esse "Ragusa"?
...
\stepcounter{footnote}\footnotetext{Daqui pra frente, \textsc\textit{ap}.}
\stepcounter{footnote}\footnotetext{Dos séculos \textsc{i} a.C. a \textsc{i} d.C. Tradução de Ragusa (2005, p.\,57; 2020, p.\,116) aqui com pequenas alterações. Todas as traduções nesta antologia, salvo quando indicado, são minhas. Os textos gregos dos epigramas são todos da edição de Paton (1916--1918), em cinco volumes.} %Dúvida: Há algum problema em separar o século da citação?
...
pudessem circular.
%Dúvida: Em \textit{oîkos} (“casa”), qual o melhor padrão? Para tradução dentro do texto de palavras estrangeiras
...
\begin{verse}
\small{\textsc{«\,Teogonia\,», Hesíodo}\footnote{Tradução minha. Edição: West (1988).}
...
ele doma no peito a mente e o prudente desígnio.\footnote{\textsc{vv} . 120--2.}
%\mbox{}\hfill
\asterisc
...
\hspace*{2em}deslassa-membros, e de sob sobrancelhas belamente fitam.\footnote{\textsc{vv} . 907--11.}}
\end{verse}
%\mbox{}\hfill
...
\hspace*{4.5em} pensareis ouvir, da própria Calíope!}\footnote{\textsc{\textit{ap} ix}, 189.}
\end{verse}
...
da boda. Segundo Cecil \textsc{m}.\,Bowra, a despeito das variações
...
\textsc\textit{ap}:\footnote{Livro \textsc{vi}, 119 e 189.} uma dedicatória às uvas viníferas,
...
algumas palavras. Um epigrama anônimo\footnote{\textsc\textit{ap}, livro \textsc{ix}, 190.}
...
Safo em hexâmetros”.\footnote{\textsc{vv} . 7--8.} %Dúvida: o que signifca esse \textsc{vv} .?

Sobre os epigramas atribuídos a Erina, Snyder observa
serem todos concernentes às mulheres: o 352\footnote{\textsc\textit{ap}, \textsc{vi}.}
retrata uma mulher de nome Agatárquis; o 710 e o 712,\footnote{\textsc\textit{ap}, \textsc{vii}} a morte da jovem
...
levou-lhe embora os dois bichinhos de estimação.}\footnote{\textsc{\textit{ap} vii}, 190.}
%\mbox{}\hfill
\end{verse}

\begin{verse}
Vivo, este homem era Manes, um escravo; morto,\\
vale agora o mesmo que o grande Dario.\footnote{Paes (1995, pp.~34--5). Dario foi imperador persa entre c. 522--586 a.C.}\footnote{\textsc{\textit{ap} vii}, 538.}
%\mbox{}\hfill 
\end{verse}
...
313:\footnote{\textsc{\textit{ap}} \textsc{ix}.}
...
190,\footnote{\textsc\textit{ap} \textsc{vii}.} já citado, é exemplo --, o que pode ser visto como uma
...
essa não sabe sequer que flores são as rosas.\footnote{\textsc{\textit{ap} v}, 170.}\medskip
...
alguém que lhe é igual, de nome Nóssis. Vai!}\footnote{\textsc\textit{ap} vii, 718. Paes (1995, pp.~36--7).}
\end{verse}
...
\begin{epigraphs} 
\qitem{Ó Píndaro, boca sacra das Musas, e loquaz Sirena -- \\
...
\qitem{Gritou alto de Tebas Píndaro; soprou deleites \\
...
Quase cinquenta anos depois, William \textsc{h}.~\,Willis oferecia ao
...
\tit{Caciagli}, S. “Sapph. fr. 27 V.: l’unità del pubblico saffico”. \textit{QUCC} 91, 2009, pp.\,63--80.
