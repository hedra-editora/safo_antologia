...
em meu sepulcro estas palavras inscreveu.\footnote{Tradução Ramos (1964, p.\,161). Noto que as Sereias são na verdade Sirenas, mulheres"-aves, no imaginário mítico grego.}
\end{quote}
...
que fincastes o início e o fim de toda a lírica.}{(\textsc{\textit{ap}} \textsc{ix}, 184)}
...
a décima Musa registrada.}{(\textsc{\textit{ap}} \textsc{ix}, 571)}
