...
\begin{verse}
\begin{quote}
\textsc{fragmentos 193 e 196 w, arquíloco}\footnote{Tradução minha. Edição: West (1988).}
...
\textsc{fragmento 287, íbico}\footnote{Tradução: Ragusa (2010, p.\,650; ver estudo às pp.\,480--507). Edição: Davies (1991). Cípris é um dos outros nomes de Afrodite.}
\textit{(Poesia mélica)}
\medskip
...
\begin{verse}
\begin{quote}
\textsc{«hipólito», eurípides}\footnote{Tradução: Oliveira (2010), em edição bilíngue que segue o texto grego de Barrett (1992). Os versos são a parte inicial do canto do coro de mulheres conhecido como ``Ode a Eros''.}
\textit{(Tragédia)}
\medskip
...
\textls[15]{Sobre os epigramas atribuídos a Erina, Snyder observa
serem todos concernentes às mulheres: o 352}\footnote{\textit{\textsc{ap}}, \textsc{vi}.}
\textls[15]{retrata uma mulher de nome Agatárquis; o 710 e o 712,}\footnote{\textit{\textsc{ap}}, \textsc{vii}} \textls[15]{a morte de 
...
\textls[10]{Muitos nomes, mas, no geral, escassa substância:}\footnote{Alguns nomes mais nebulosos ainda são
...
provavelmente do século \textsc{v} a.C.} \textls[10]{é o que se pode espremer do acúmulo dos
