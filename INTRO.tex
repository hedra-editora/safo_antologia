...
distinguindo entre si ---, Safo não é o único nome feminino da poesia da Grécia
	antiga, mas de sua primeira fase histórica, a arcaica\footnote{\textls[-20]{O adjetivo é
		...
		antiga da Grécia antiga, e divide"-se em duas etapas: a arcaica, até \textit{c.}\,550~a.\,C., e a tardo"-arcaica, \textit{c.}\,550--450~a.\,C.; ver Shapiro (2007, pp.\,1--3) a respeito.}\looseness=-1} (\textit{c.}\,800--480~a.\,C.). Nascida em 630 a.\,C., de família
...
desde já, sobretudo no período arcaico e depois no clássico (\textit{c.}\,480--323 a.\,C.), pelo menos até \textit{c}.\,400 a.\,C., a poesia grega é eminentemente de tradição oral e inserida no
...
\textls[-15]{Decorre do modo de \textit{performance}, justamente, o nome tardio para a mélica,
...
\textit{lírica}, rigorosamente, o gênero da canção para a lira e tão"-somente ele. }\looseness=-1
...
\textls[-22]{Claro está, a esta altura, que há uma defasagem considerável, para não dizer
 ...
 Anne P. Burnett:}\looseness=-1

\begin{quote}
\textls[20]{{[}\ldots{}{]} é mais engenhosa e menos apaixonada,
...
\textls[-20]{Em conclusão a essas palavras, cabe esclarecer que não se trata, aqui, de negar
...
\begin{quote}
\textls[10]{Nós todos, quando lemos a lírica grega, ficamos desapontados em certo sentido:
...
\textls[-10]{Esse é um fato que escolhemos não encarar --- não de frente e constantemente.
...
existência. {[}\ldots{}{]}}\looseness=-1

\textls[10]{É o leitor, então, que deve se lembrar, quando eu me esquecer, que a lírica
...
\textls[15]{O mistério, então, persiste e as perguntas que estimula --- e que com frequência
...
cujo \textit{corpus} é o mais extenso}\looseness=-1\footnote{Cerca de duzentos fragmentos, um dos quais é,
...
\textls[-10]{Assim sendo, o fato de que Safo é a única poeta do período
...
\textls[-10]{Considerados essa tradição e o elenco de poetas mulheres, porém,
...
\begin{quote}
\textls[15]{Neste tempo que se tem na memória, mulher alguma nem de longe se revela páreo à graça daquela poeta.}\footnote{ \textit{Geografia} (13. 2. 3).}
\end{quote}

\textls[-15]{No desenho geográfico composto pelos nomes de poetas mulheres
...
nessas outras regiões, do que aquela “que conhecemos no mundo de Atenas”.}\looseness=-1\footnote{ Lesky (1995, p.\,210).} \textls[-15]{A
...
aceitação do fazer poético exercido por uma mulher.}\looseness=-1
...
\textls[10]{Nada disso pode ser afirmado com segurança, mas não é disparate imaginar que o acesso
...
meninas aristocráticas de Mitilene”.} \textls[10]{cujas composições, como as dos demais
...
\textls[15]{Da busca de Safo, a mulher, e da formação da poeta, voltamos de mãos
...
\textls[-10]{A condição de mulher poeta cujas canções têm na temática erótico"-amorosa e no
...
imagens da poeta, ela fornece as indicações das fontes antigas.} \textls[-10]{comenta as
...
\textls[10]{Ora, a leitura dos modernos dessa intricada trama biográfica não foi, no mais
das vezes, menos infeliz que a dos antigos. Most comenta, por exemplo,
a dos românticos:}

\begin{quote}
\textls[10]{\textit{Condensando} numa única pessoa as muitas contradições com as quais a
...
\textls[-20]{Em verdade, uma revisão das leituras modernas de Safo mostra que cada época,
 ...
 muitas vezes usada para alavancar tais projeções.}\looseness=-1

\textls[-15]{A imagem da Safo \textit{lésbica} construiu"-se nesse movimento, e ganhou fôlego
...
Tal olhar desconsidera ou minimiza o fato de que o uso da poesia como história é, no mínimo, imprudente, e mais: de que a defasagem entre nós e os clássicos reside também no modo como percebemos a sexualidade, como bem sublinham os dizeres de Maria Fernanda Brasete:}\looseness=-1

\begin{quote}
\textls[-20]{Na antiga cultura grega, efectivamente, o relacionamento erótico entre pessoas do mesmo sexo – que hoje apenas conhecemos de forma fragmentária e indirecta, através de escassos documentos literários e iconográficos – parecia integrar, naturalmente, a vida dos membros de uma sociedade, que, talvez por essa razão, nunca criou um léxico específico para o designar, nem nunca o entendeu de um modo discriminatório ou em termos psico-morais. Mas falar de erotismo grego não é o mesmo que falar de sexualidade, porque, em primeiro lugar, não se trata de fenómenos atemporais e, por conseguinte, não podem ser descontextualizados das práticas sociais institucionalizadas numa determinada comunidade histórica.}\looseness=-1\footnote{Brasete (2009, p.\,292).}
\end{quote}


\textls[10]{Digo certa leitura, porque há outros modos, mais
...
\textls[10]{A partir de Aristófanes (séculos \textsc{v}--\textsc{iv} a.\,C.) e da comédia clássica, pelo menos, a
referência às mulheres de Lesbos e o uso de verbos como \textit{lesbiázein} e
\textit{lesbízein}}\footnote{``Agir como uma mulher de Lesbos''.} \textls[10]{conotavam luxúria e
lascívia; em particular, diz Hallett, a prática da
felação, que as lésbias teriam inventado}\footnote{ Hallett (1996, p.\,129).} \textls[10]{--- algo sem qualquer respaldo
...
\textls[-10]{A despeito dessas ressalvas, \textit{Safo de Lesbos} é designação que
...
\textls[15]{Repare"-se, a propósito, que o adjetivo \textit{lésbica} não existia na
...
\begin{quote}
\textls[20]{Será justificada a relação entre a ilha de Lesbos e o homossexualismo das
mulheres? Existiriam razões para crer que Safo de Lesbos fosse uma ``lésbica''?}

\textls[15]{É essa a \textit{grande questão sáfica} {[}\ldots{}{]} que já era debatida na Antiguidade, mas
...
\textls[-10]{O grau elevado de complexidade da chamada \textit{questão sáfica} é um alerta
...
\begin{quote}
\textls[-20]{O texto de Safo está em fragmentos {[}\ldots{}{]} A linguagem é difícil, a sociedade,
...
melhor, o que construímos como homossexualidade) e sexualidade feminina.}\looseness=-1\footnote{ Parker (1996, p.\,149).}
\end{quote}
...
originalmente publicado em 1978.}\looseness=-1\footnote{ Dover (1994).}
...
\begin{quote}
\begin{verse}
\hspace{.2em}\textsc{«teogonia», hesíodo}\\
...
ele doma no peito a mente e o prudente\qb{} desígnio.\footnote{Tradução minha. Edição: West (1988), versos 120--2.}\\
...
\hspace*{2em}deslassa-membros, e de sob sobrancelhas belamente\qb{}fitam.\footnote{Versos 907--11.}
\end{verse}
\end{quote}
...
\begin{quote}
\begin{verse}
\hspace{.2em}\textsc{fragmentos 193 e 196 w, arquíloco}\footnote{Tradução minha. Edição: West (1988).}\\
...
\hspace{.2em}\textsc{fragmento 287, íbico}\footnote{Tradução: Ragusa (2010, p.\,650; ver estudo às pp.\,480--507). Edição: Davies (1991). Cípris é um dos outros nomes de Afrodite.}\\
\textit{(Poesia mélica)}
\smallskip 
...
\begin{quote}
\begin{verse}
\hspace{.2em}\textsc{«hipólito», eurípides}\footnote{Tradução: Oliveira (2010), em edição bilíngue que segue o texto grego de Barrett (1992). Os versos são a parte inicial do canto do coro de mulheres conhecido como ``Ode a Eros''.}\\
\textit{(Tragédia)}
\smallskip
...
\textls[10]{Confrontados com os versos que reproduzi de Hesíodo, de Arquíloco, de Eurípides,
...
\textls[-7]{O recorte de um universo que é distintamente feminino no \textit{corpus} preservado de sua poesia, inclusive
...
relação heterossexual no casamento adquiria um caráter muito mais íntimo”.}\looseness=-1\footnote{ Bremmer (1995, p.\,24).} \textls[-7]{Na
...
aristocráticos”}\looseness=-1\footnote{ Bremmer (1995, pp.\,20--21).} \textls[-7]{--- “mostram que as relações homossexuais normalmente
ocorriam só entre adultos e rapazes”,}\looseness=-1\footnote{ Bremmer (1995, p.\,12).} \textls[-7]{sendo “um aspecto estabelecido do
caminho de um rapaz rumo à idade adulta”.}\looseness=-1\footnote{ Bremmer (1995, p.\,12). Ao menos, na visão
externa dessas relações; da interna, pouco se pode dizer, lembra Bremmer (p.\,20).} \textls[-7]{E frisa Bremmer que tais relações não implicavam a rejeição “do contato
...
mundo das mulheres.}\looseness=-1\footnote{ Bremmer (1995, p.\,26) ainda observa que era,
...
\textls[-20]{Melhor é, portanto, ir para perto da obra da poeta lésbia, como espero que esta
...
\textls[-15]{Como se vê, o modo de \textit{performance} nomeia o gênero;
...
\textls[10]{Considerando que as composições da mélica grega arcaica “estavam destinadas,
...
\begin{quote}
\textls[15]{apareça dominada por um maior traço --- o caráter circunstancial do discurso --- de
...
\textls[20]{A mélica nas modalidades solo e coral está representada no \textit{corpus} sobrevivente
...
\textls[20]{Falemos um pouco mais da canção coral.}
...
\textls[-20]{Nessa atmosfera festiva e de celebração pública e coletiva, o canto tinha por
“tônica dominante”, frisa Herington, “o \textit{prazer}, humano e
divino”, pois eram homens e deuses homenageados a um só tempo.}\looseness=-1\footnote{ Herington (1985, p.\,6).} \textls[-20]{Mas, para além
...
“tem papel vital na autoconsciência pública da cidade”.}\looseness=-1\footnote{Most (1982, p.\,94).}
\textls[-20]{Lembremos que, no universo grego, “participar de uma \textit{performance} coral ou assisti"-la desempenhavam um papel central na vida cultural e musical”, frisa Laura Swift.}\looseness=-1\footnote{Swift, (2010, p.\,1).} \textls[-20]{E a canção coral era apresentada em múltiplas ocasiões de distintas naturezas e amplitudes, por toda a Grécia, em cujas cidades demarcava “os momentos mais significativos da vida de indivíduos e da comunidade, de casamentos, a funerais, a celebrações religiosas cívicas”.}\looseness=-1\footnote{Swift, (2010, p.\,2).} \textls[-20]{Por conta disso, desde a infância os gregos (homens e mulheres) eram expostos ao treinamento para a \textit{performance} coral --- canto, dança e o tocar de instrumentos ---, que se inscreve nas dimensões política, cultural, ritual, social e cultual da vida cotidiana, e na dimensão da \textit{paideía} grega, “a educação em amplo sentido”, como ressalta Anton Bierl.}\looseness=-1\footnote{Bierl (2011, p.\,417).}

\textls[-20]{As composições de Safo, volto a afirmar, são canções, mais
...
diz a advertência de Guerrero,}\looseness=-1\footnote{ Guerrero (1998, p.\,18).} \textls[-20]{uma vez que, na era arcaica,
completa Eric A. Havelock, }\looseness=-1
...
\end{quote}
 ...
 \textls[-20]{A poesia grega antiga, cabe recordar, não se
 ...
 sua audiência, sua ocasião e seu modo de \textit{performance} presumivelmente com participação da própria poeta, na Mitilene arcaica, e de seu grupo de \textit{parthénoi}, em festivais cívico"-cultuais públicos e em cerimônias de casamento, ocasiões valorizadas no estudo de Franco Ferrari.}\looseness=-1\footnote{Ferrari (2010) se baseia nas novas reflexões a que levaram os avanços nos estudos de \textit{performance} e a descoberta do novo fragmento da poeta (``Canção sobre a velhice''), em 2004, que nos fez reavaliar a coralidade em Safo e a natureza coral de sua associação de \textit{parthénoi}. Ferrari traz um olhar fresco ao aproximá"-la de Álcman, o poeta dos partênios --- canções para coros de virgens --- atuante na Esparta de c.\,620 a.\,C. Ver ainda Ragusa (2019a, pp.\,85--111; 2019b, pp.\,211--39).}
\textls[-20]{Diga"-se, nas palavras de Giulia Sissa,}\looseness=-1\footnote{Sissa (1990, p.\,76).} \textls[-20]{que a \textit{parthénos} se define “por idade e estatuto marital”, e é um “estágio pelo qual toda mulher passava na rota rumo à completa integração social” pelo \textit{gámos} (casamento). A \textit{parthénos} é, pois, aquela que chegou ao amadurecimento sexual indicado pela menarca, ao florescer da feminilidade. Como diz Mary Lefkowitz,}\looseness=-1\footnote{Lefkowitz (1995, p.\,32).} \textls[-20]{“o principal papel da mulher na sociedade antiga” era desempenhado pela \textit{gyné}, a ``mulher adulta'': o de ser esposa e mãe; daí o interesse e a atratividade da \textit{parthénos}, cuja energia vital deve convergir para o mundo do \textit{gámos} que a institucionaliza socialmente e que lhe confere, uma vez consumado, um lugar social definido na condição de \textit{gyné.} Daí o fascínio da figura da \textit{parthénos}, cujos principais cantores são decerto os mélicos Álcman, poeta ativo na Esparta de c.\,620, famoso pelas canções para coros de virgens (\textit{partênios}) e Safo.
No mundo da coralidade e como \textit{khorodidáskalos}, ``mestra do coro'', equiparada à líder das Musas,}\looseness=-1\footnote{Bela Voz ou Calíope.} \textls[-20]{vislumbra"-a um epigrama anônimo que a insere no famoso templo lésbio de Hera, em que, segundo Alceu,}\looseness=-1\footnote{Fr.\,130\textsc{b}, traduzido em Ragusa, 2013.} \textls[-20]{contemporâneo da poeta em Lesbos, havia concursos anuais de beleza em homenagem à deusa:}\looseness=-1

\begin{quote}
\begin{verse}
\hspace{.1em}Vinde ao sacro recinto esplêndido de Hera de olhos de\qb{}touro,\\
...
\hspace*{4.5em} \textls[-20]{pensareis ouvir, da própria Calíope!}\looseness=-1\footnote{\textit{\textsc{ap}} \textsc{ix}, 189.}
\end{verse}
\end{quote}
...
\textls[-15]{Considerados os epitalâmios sáficos, bem como o já referido fragmento de
narrativa mítica,}\looseness=-1\footnote{``As bodas de Heitor e Andrômaca''.} \textls[-15]{neles
...
Safo, a qual, voltando"-se aos outros fragmentos, sobretudo aos mais famosos,}\looseness=-1\footnote{Fragmentos 1, 2, 16, 31, 94, 96.} \textls[-15]{insiste em tomar por íntima, pessoal e privada a voz de seus versos, nos quais ela se revela “a maior mestra em pseudointimidade”, nas palavras de Ruth Scodel, dando"-nos amiúde os seus poemas “uma impressão extraordinariamente exitosa de terem sido compostos para ela e suas amigas” --- impressão que “por vezes ela manipula”.}\looseness=-1\footnote{Scodel (1996, p.\,77).}
\textls[-15]{A temática
...
\textls[-15]{No que tange ao biografismo e à simplista equiparação poeta"-\textit{persona} aos quais tão bem se prestam as canções da mélica sáfica forjadas, pela habilidade retórica, para serem percebidas como intimistas, pessoais e privadas, há que reafirmar: se a identificação é problemática,
...
\begin{quote}
\textls[20]{Dado o fato de que as mulheres gregas antigas, e tanto mais as jovens, não eram encorajadas a falar em público, é notável que tantas \textit{performances} de coros de moças jovens sejam atestadas, especialmente no período arcaico.}
\end{quote}

\textls[15]{Atestadas, sim; sobreviventes, bem poucas. Mas canções como as de Álcman --- os \textit{partênios} --- ``adotam uma perspectiva distintivamente feminina, ambos nos mitos que contam e nas visões que expressam sobre outras mulheres'', prossegue, esclarecendo que usa o termo feminino como designação para ``um conceito ou comportamento que uma dada cultura tipicamente associa às mulheres {[}\ldots{}{]}''.}\footnote{Lardinois (2011, p.\,161).}
...
\begin{quote}
\begin{verse}
\hspace{.2em}\ldots{} eu censuro a clarissonante\\
...
Ateneu (séculos \textsc{ii}--\textsc{iii} d.\,C.), no \textit{Banquete dos eruditos}:}\looseness=-1\footnote{15, 694\textsc{a}.}
...
\begin{quote}
\begin{verse}
\hspace{.2em}\ldots{} o que de mais belo eu deixo: a luz do sol,\\
...
militar contra Cleomenes, de Esparta, o que jogaria sua datação para \textit{c.}\,494 a.\,C. Pausânias descreve, no santuário de Afrodite em Argos, diante da
...
\begin{quote}
\begin{verse}
\hspace{.2em}{[}\ldots{}{]} sobre mim Terpsícore {[}\ldots{}{]}\\
...
\textls[15]{Há, ainda, fragmentos de alguns versos, uma única linha ou palavra, os quais
...
\begin{quote}
\begin{verse}
\hspace{.2em}{[}\ldots{}{]} canto as excelências dos heróis\\
...
\textls[-15]{Nesse mundo, “a poesia do passado”, declara Gentili, “passou a
ser lida como literatura pura e simples”, embora fosse ainda recitada --- reflexo
ainda vivo da cultura oral em que se produziu.}\looseness=-1\footnote{ Gentili (1990, p.\,37).} \textls[-15]{E em termos da poesia,
...
dedicatórias, casos amorosos, animais de estimação e assim por diante”.}\looseness=-1\footnote{ Snyder (1989, p.\,66).}
\textls[-15]{Originalmente, o epigrama “limitava"-se a servir de epitáfio”, anota a
...
\begin{quote}
\begin{verse}
\hspace{.2em}Jazes sob o áureo pórtico de Afrodite,\\
...
\textls[-25]{Sobre os epigramas atribuídos a Erina, Snyder observa
serem todos concernentes às mulheres: o 352}\looseness=-1\footnote{\textit{\textsc{ap}}, \textsc{vi}.}
\textls[-25]{retrata uma mulher de nome Agatárquis; o 710 e o 712,}\looseness=-1\footnote{\textit{\textsc{ap}}, \textsc{vii}} \textls[-25]{a morte de 
Báucis, sua amiga, que jovem como a poeta morreu --- na noite das suas núpcias.
Cito da poeta o epigrama 710, na tradução do poeta Péricles Eugênio da Silva Ramos:}\looseness=-1

\begin{quote}
\begin{verse}
\hspace{.2em}Ó estrelas e Sereias, urna funerária\\ 
...
\begin{quote}
\begin{verse}
\hspace{.2em}Para o seu gafanhoto, rouxinol dos campos, e a sua\\*
...
\hspace{.1em}Senta-te de todo sob as belas folhas vicejantes do loureiro\\
...
190,}\looseness=-1\footnote{\textit{\textsc{ap}} \textsc{vii}.} \textls[-20]{já citado, é exemplo ---, o que pode ser visto como uma
...
\begin{quote}
\begin{verse}
\hspace{.2em}Nada mais doce que o amor; tudo quanto haja de ditoso\\*
lhe fica atrás e eu cuspo da boca até o mel.\\*
\textls[-20]{Eis o que diz Nóssis; aquela a quem a Cípria}\looseness=-1\footnote{ Outro nome de Afrodite, a deusa do amor erótico, da beleza, da sedução.} \textls[-20]{não beijou,}\looseness=-1\\*
essa não sabe sequer que flores são as rosas.\footnote{\textit{\textsc{ap}} \textsc{v}, 170.}
...
\textls[10]{Muitos nomes, mas, no geral, escassa substância:}\footnote{\textls[-15]{Alguns nomes mais nebulosos ainda são
...
provavelmente do século \textsc{v} a.\,C.}\looseness=-1} \textls[10]{é o que se pode espremer do acúmulo dos
...
\noindent{}\textls[-20]{Não podemos precisar as razões que favoreceram ou não a
...
acima.}\looseness=-1\footnote{Pfeiffer (1998, p.\,205). Traduções: Ragusa (2010, pp.\,27--8), com pequenas modificações.}
...
\textls[-15]{Antes da Biblioteca, a circulação da poesia grega antiga, incluindo a jâmbica,
...
simples repetição propiciada pela memória,}\looseness=-1\footnote{ Ver Herington (1985, pp.\,45--8) a respeito.} \textls[-15]{por inscrições comemorativas em monumentos, por possíveis
e anteriores edições}\looseness=-1\footnote{ Harvey (1955, p.\,159) afirma que “não há razão para pensar
que as edições alexandrinas foram as primeiras a existir”; e na Atenas clássica
circulavam edições disponíveis dos grandes poetas.} \textls[-15]{--- termo que deve ser
entendido como cópias de um registro original, em quantidade e difusão muito
restritas e, certamente, custosa.}\looseness=-1\footnote{ \textls[-20]{Ver Havelock (1996, p.\,26). Tais
...
o que copiavam.}\looseness=-1} \textls[-15]{Tudo isso contribui para a sobrevivência dos textos até os
...
\textls[-20]{Desde a década final do século \textsc{xix} a meados do século \textsc{xx}, sobretudo,
...
\textls[-20]{Com os acréscimos, que hoje ocorrem em ritmo bem mais lento,
...
papiros não fizeram muito por nós”.}\looseness=-1\footnote{ Kenyon (1919, p.\,9).} \textls[-20]{Animado com os acontecimentos então
...
\begin{quote}
\textls[-20]{Devemos, é claro, ter em mente as severas limitações de nossa evidência. Quase
...
--- devem, necessariamente, ter"-nos roubado a vasta maioria dos textos antigos.}\looseness=-1\footnote{ Willis (1968, pp.\,205--6).}
\end{quote}

\textls[-20]{Além dos fatores relativos ao clima, há que se considerar a sorte, as limitações
...
romano (31 a.\,C.--476 d.\,C.) e bizantino (476--1453).}\looseness=-1\footnote{ Willis (1968, pp.\,211--3).}
...
\tit{havelock}, \textls[-20]{E. \textit{A revolução da escrita na Grécia e suas
