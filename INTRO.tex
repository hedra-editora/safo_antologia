...
\begin{quote}
\begin{verse}
\textsc{\textbf{poesia jâmbica}\quad fragmentos 193 e 196 w, de arquíloco}\footnote{Tradução minha. Edição: West (1988).}\\
...
\textsc{\textbf{poesia mélica}\quad fragmento 287, de íbico}\footnote{Tradução: Ragusa (2010, p.\,650; ver estudo às pp.\,480--507). Edição: Davies (1991). Cípris é um dos outros nomes de Afrodite.}\\
...
\hspace*{4.5em} \textls[-15]{pensareis ouvir, da própria Calíope!}\looseness=-1\footnote{\textit{\textsc{ap}} \textsc{ix}, 189.}
\end{verse}
\end{quote}
