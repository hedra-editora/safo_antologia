...
distinguindo entre si ---, Safo não é o único nome feminino da poesia da Grécia
	antiga, mas de sua primeira fase histórica, a arcaica\footnote{\textls[-20]{O adjetivo é
		...
		550 a.C., e a tardo"-arcaica, \textit{c.} 550--450 a.C.; ver Shapiro (2007, pp.\,1--3) a respeito.}\looseness=-1} (\textit{c.} 800--480 a.C.). Nascida em 630 a.C., de família
...
\textls[15]{Recompondo minimamente o quadro, haveria para a canção solo várias audiências e
...
\begin{quote}
\textls[15]{é o lugar de conservação
...
\textls[10]{No andamento do evento, o beber era privilegiado e, por isso, tornou"-se
...
\textls[10]{Nesse sentido, mais uma vez, não haveria obstáculo às canções de Safo em que a primeira pessoa do singular é feminina. E não por acaso se diz ser o simpósio uma
